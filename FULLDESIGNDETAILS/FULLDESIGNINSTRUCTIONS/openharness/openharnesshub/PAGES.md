...
| Route | Page | Purpose |
|---|---|---|
| `/pipelines` | Explore pipelines | Prebuilt governed pipelines (lift shown here). **Modality tabs**: Text (default) · Image · Audio · Video — 4 example pipelines each. Top filter bar: **Source** = Free·OHH / Premium·OHH / Community free / Community paid. |
...
| Route | Page | Purpose |
|---|---|---|
| `/connect` | MCP bridge | Local-first: your agents source locally, call OHH over MCP to fill gaps; privacy boundary. |
