...
(function (root) {
  ...
  const ENTITIES = {
    ...
    openMCPHub: {
      name: 'OpenMCPHub', wordmark: 'OpenMCPHub.io', domain: 'OpenMCPHub.io', kind: 'MCP server intelligence',
    ...
    openCompressionHub: {
      name: 'OpenCompressionHub', wordmark: 'OpenCompressionHub.io', domain: 'OpenCompressionHub.io', kind: 'Compression & budget intelligence',
    ...
    openBenchmarkHub: {
      name: 'OpenBenchmarkHub', wordmark: 'OpenBenchmarkHub.io', domain: 'OpenBenchmarkHub.io', kind: 'Benchmark intelligence',
    ...
    openReviewHub: {
      name: 'OpenReviewHub', wordmark: 'OpenReviewHub.io', domain: 'OpenReviewHub.io', kind: 'Review intelligence',
    ...
    openTemplatesHub: {
      name: 'OpenTemplatesHub', wordmark: 'OpenTemplatesHub.io', domain: 'OpenTemplatesHub.io', kind: 'Template families',
    ...
    openEndpointHub: {
      name: 'OpenEndpointHub', wordmark: 'OpenEndpointHub.io', domain: 'OpenEndpointHub.io', kind: 'Endpoint due-diligence',
    ...
    openSandboxHub: {
      name: 'OpenSandboxHub', wordmark: 'OpenSandboxHub.io', domain: 'OpenSandboxHub.io', kind: 'Sandbox intelligence',
    ...
    openAgentHub: {
      name: 'OpenAgentHub', wordmark: 'OpenAgentHub.io', domain: 'OpenAgentHub.io', kind: 'Agent-runtime registry',
    ...
    openReceiptHub: {
      name: 'OpenReceiptHub', wordmark: 'OpenReceiptHub.io', domain: 'OpenReceiptHub.io', kind: 'Portable receipts',
    ...
    openStateHub: {
      name: 'OpenStateHub', wordmark: 'OpenStateHub.io', domain: 'OpenStateHub.io', kind: 'Agent state',
    ...
    openReconciliationHub: {
      name: 'OpenReconciliationHub', wordmark: 'OpenReconciliationHub.io', domain: 'OpenReconciliationHub.io', kind: 'Reconciliation methods',
    ...
    openHardeningHub: {
      name: 'OpenHardeningHub', wordmark: 'OpenHardeningHub.io', domain: 'OpenHardeningHub.io', kind: 'Hardening methods',
    ...
    openEnrichmentHub: {
      name: 'OpenEnrichmentHub', wordmark: 'OpenEnrichmentHub.io', domain: 'OpenEnrichmentHub.io', kind: 'Enrichment methods',
    ...
    openOptimizationHub: {
      name: 'OpenOptimizationHub', wordmark: 'OpenOptimizationHub.io', domain: 'OpenOptimizationHub.io', kind: 'Optimization methods',
    ...
    openVerificationHub: {
      name: 'OpenVerificationHub', wordmark: 'OpenVerificationHub.io', domain: 'OpenVerificationHub.io', kind: 'Verification methods',
  ...
  const LAYERS = [
    ...
    { id: 'candidate', label: 'Private bench', sub: 'built on the kit · private until a competitor enters the lane', items: ['openTemplatesHub', 'openEndpointHub', 'openEnvHub', 'openSandboxHub', 'openAgentHub', 'openReceiptHub', 'openStateHub', 'openReconciliationHub', 'openHardeningHub', 'openEnrichmentHub', 'openOptimizationHub', 'openVerificationHub'] },
  ];
