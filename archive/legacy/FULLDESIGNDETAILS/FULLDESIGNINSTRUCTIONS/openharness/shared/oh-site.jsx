        ...
        {forgot ? (
          sent ? (
            <>
              ...
              <div className="sub">If an account exists for that address, a reset link is on its way.</div>
          ...
          <>
            ...
            <div className="ohs-oauth">
              <button className="ohs-oauth-btn">◑ Continue with Google</button>
              <button className="ohs-oauth-btn">⎔ Continue with GitHub</button>
            </div>
            <div className="ohs-divider">or</div>
            {signup && <label className="oh-field"><span>Name</span><input placeholder="Ada Lovelace" /></label>}
            <label className="oh-field"><span>Work email</span><input type="email" placeholder="you@company.com" /></label>
            ...
            <button className="oh-btn oh-btn--primary" onClick={() => navigate('/app')}>{signup ? 'Create account' : 'Sign in'}</button>
