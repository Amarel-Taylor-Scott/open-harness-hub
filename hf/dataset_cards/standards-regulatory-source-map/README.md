...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/standards-regulatory-source-map` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Official public source documentation and Open Harness Hub source-surface planning
