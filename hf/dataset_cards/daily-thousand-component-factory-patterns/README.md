...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/daily-thousand-component-factory-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub source surface seed row exporter, Open Harness Hub use-case seed row exporter, Open Harness Hub Postgres and pgvector component store plan
