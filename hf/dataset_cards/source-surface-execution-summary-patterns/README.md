...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/source-surface-execution-summary-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub source-surface partition, replay, row-emission, and load-plan outputs
