...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/containerized-worker-orchestration-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub object factory worker fleet architecture, Open Harness Hub trajectory fragment cache architecture, User-requested containerized worker and prompt-cache expansion from 2026-05-25
