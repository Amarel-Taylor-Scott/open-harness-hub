...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/cis-benchmarks-and-disa-stig-controls` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
