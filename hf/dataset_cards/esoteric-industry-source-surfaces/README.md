...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/esoteric-industry-source-surfaces` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub contributor-authored synthetic source-surface seeds, User-provided vertical examples from the 1M object scaling goal
