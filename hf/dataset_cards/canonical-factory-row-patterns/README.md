...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/canonical-factory-row-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Synthetic Open Harness Hub fixtures, Open Harness Hub canonical Postgres schema
