...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/promotion-cdc-bridge-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub approved component promotion planner, Open Harness Hub component CDC planner
