...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/multimodal-public-service-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub public-service and quality workflow catalog, User-requested multimodal harness expansion from 2026-05-25
