...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/daily-partition-load-audit-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub daily thousand component factory, Open Harness Hub factory JSONL relationship preflight, Open Harness Hub factory JSONL bulk COPY loader, Open Harness Hub staged-versus-committed load audit
