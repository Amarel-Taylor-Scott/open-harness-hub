...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/procedure-knowledge-object-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub procedure knowledge object architecture
