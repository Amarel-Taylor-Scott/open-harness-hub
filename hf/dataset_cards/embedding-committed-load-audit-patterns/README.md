...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/embedding-committed-load-audit-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub embedding committed load audit, Open Harness Hub pgvector embedding load plan, Open Harness Hub object count report
