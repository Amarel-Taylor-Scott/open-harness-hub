...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/object-count-db-bootstrap-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub generated-object storage architecture
