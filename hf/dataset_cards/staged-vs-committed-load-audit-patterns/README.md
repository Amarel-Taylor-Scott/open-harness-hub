...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/staged-vs-committed-load-audit-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: db/postgres/object_count_report.sql, Open Harness Hub bulk load manifests
