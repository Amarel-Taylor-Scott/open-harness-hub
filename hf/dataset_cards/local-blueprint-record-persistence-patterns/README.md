...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/local-blueprint-record-persistence-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub local sentence-to-pipeline demo output record architecture, Open Harness Hub canonical Postgres schema
