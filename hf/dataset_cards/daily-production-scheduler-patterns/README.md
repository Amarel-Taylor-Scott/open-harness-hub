...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/daily-production-scheduler-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub daily production runner, Open Harness Hub daily production target, Open Harness Hub staged load audit reports
