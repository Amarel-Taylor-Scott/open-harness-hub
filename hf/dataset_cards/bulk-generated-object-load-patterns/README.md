...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/bulk-generated-object-load-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub Postgres bootstrap and generated object storage architecture
