...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/promotion-decision-load-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub promotion decision schema, Open Harness Hub candidate promotion scorer
