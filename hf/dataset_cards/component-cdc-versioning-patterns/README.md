...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/component-cdc-versioning-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub Postgres component schema, Open Harness Hub source governance and entity resolution architecture, Open Harness Hub public fact archive versioning pipeline
