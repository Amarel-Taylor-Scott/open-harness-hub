...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/community-health-worker-protocols-low-resource` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
