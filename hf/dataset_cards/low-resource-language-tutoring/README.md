...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/low-resource-language-tutoring` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **collected_by**: Open Harness Hub research agent (manual curation from public-domain syllabi)
