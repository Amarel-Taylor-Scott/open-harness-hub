...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/expert-email-grounded-verification-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: User-described DueCare/OpenClaw expert email verification workflow from 2026-05-25, Open Harness Hub source governance and signed knowledge network architecture
