...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/public-source-scan-job-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub public source scan job emitter, Open Harness Hub object factory job schema
