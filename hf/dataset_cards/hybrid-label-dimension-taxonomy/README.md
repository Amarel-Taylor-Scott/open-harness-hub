...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/hybrid-label-dimension-taxonomy` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub hybrid label and dimensional search architecture, schema.org concept vocabulary
