...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/curriculum-standards-alignment-graph` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
