...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/local-hash-embedding-worker-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub local hash embedding worker, Open Harness Hub embedding execution planner, Open Harness Hub vector readiness audit
