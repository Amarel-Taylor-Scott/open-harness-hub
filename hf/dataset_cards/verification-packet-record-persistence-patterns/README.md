...
<!-- Generated from Open Harness Hub manifest `knowledge-pack/verification-packet-record-persistence-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Open Harness Hub expert email and grounded verification architecture, Open Harness Hub canonical factory row families
