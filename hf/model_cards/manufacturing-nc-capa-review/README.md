...
<!-- Generated from Open Harness Hub manifest `harness/manufacturing-nc-capa-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
...
```bibtex
@misc{manufacturing-nc-capa-review_open_harness_hub,
  title  = {Manufacturing NC CAPA review harness},
  author = {Open Harness Hub contributors},
  url    = {https://open-harness-hub.dev/harness/manufacturing-nc-capa-review},
  version= {0.1.0},
  year   = {2026}
}
```

License: `MIT`. Hub component: `harness/manufacturing-nc-capa-review`.
