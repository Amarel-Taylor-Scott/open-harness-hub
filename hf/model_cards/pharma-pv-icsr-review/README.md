...
<!-- Generated from Open Harness Hub manifest `harness/pharma-pv-icsr-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
...
```bibtex
@misc{pharma-pv-icsr-review_open_harness_hub,
  title  = {Pharma PV ICSR review harness},
  author = {Open Harness Hub contributors},
  url    = {https://open-harness-hub.dev/harness/pharma-pv-icsr-review},
  version= {0.1.0},
  year   = {2026}
}
```

License: `MIT`. Hub component: `harness/pharma-pv-icsr-review`.
