...
<!-- Generated from Open Harness Hub manifest `harness/telecom-outage-postmortem-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
...
```bibtex
@misc{telecom-outage-postmortem-review_open_harness_hub,
  title  = {Telecom Outage Postmortem review harness},
  author = {Open Harness Hub contributors},
  url    = {https://open-harness-hub.dev/harness/telecom-outage-postmortem-review},
  version= {0.1.0},
  year   = {2026}
}
```

License: `MIT`. Hub component: `harness/telecom-outage-postmortem-review`.
