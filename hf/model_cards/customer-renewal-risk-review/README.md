...
<!-- Generated from Open Harness Hub manifest `harness/customer-renewal-risk-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
...
```bibtex
@misc{customer-renewal-risk-review_open_harness_hub,
  title  = {Customer Renewal Risk review harness},
  author = {Open Harness Hub contributors},
  url    = {https://open-harness-hub.dev/harness/customer-renewal-risk-review},
  version= {0.1.0},
  year   = {2026}
}
```

License: `MIT`. Hub component: `harness/customer-renewal-risk-review`.
