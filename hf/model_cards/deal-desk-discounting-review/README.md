...
<!-- Generated from Open Harness Hub manifest `harness/deal-desk-discounting-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
...
```bibtex
@misc{deal-desk-discounting-review_open_harness_hub,
  title  = {Deal Desk Discounting review harness},
  author = {Open Harness Hub contributors},
  url    = {https://open-harness-hub.dev/harness/deal-desk-discounting-review},
  version= {0.1.0},
  year   = {2026}
}
```

License: `MIT`. Hub component: `harness/deal-desk-discounting-review`.
