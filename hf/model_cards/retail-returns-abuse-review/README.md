...
<!-- Generated from Open Harness Hub manifest `harness/retail-returns-abuse-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
...
```bibtex
@misc{retail-returns-abuse-review_open_harness_hub,
  title  = {Retail Returns Abuse review harness},
  author = {Open Harness Hub contributors},
  url    = {https://open-harness-hub.dev/harness/retail-returns-abuse-review},
  version= {0.1.0},
  year   = {2026}
}
```

License: `MIT`. Hub component: `harness/retail-returns-abuse-review`.
