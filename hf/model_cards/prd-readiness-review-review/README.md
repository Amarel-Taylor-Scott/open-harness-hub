...
<!-- Generated from Open Harness Hub manifest `harness/prd-readiness-review-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
...
```bibtex
@misc{prd-readiness-review-review_open_harness_hub,
  title  = {PRD Readiness Review review harness},
  author = {Open Harness Hub contributors},
  url    = {https://open-harness-hub.dev/harness/prd-readiness-review-review},
  version= {0.1.0},
  year   = {2026}
}
```

License: `MIT`. Hub component: `harness/prd-readiness-review-review`.
