...
architecture/search_exhaustion_ladder.json and drives scripts.interrogation_engine to INJECT new direction —
...
LADDER = REPO / "architecture" / "search_exhaustion_ladder.json"
