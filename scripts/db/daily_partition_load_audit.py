...
def _self_test() -> int:
    partitions = [
        Path("dist/daily-component-batch/2026-05-26"),
        Path("dist/daily-component-batch/2026-05-27"),
    ]
    ...
    output_dir = Path("dist/daily-component-batch-load-audit/self-test").absolute()
