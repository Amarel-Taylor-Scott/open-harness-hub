...
def _self_test() -> int:
    stored = Path("dist/local-hash-embedding-worker/2026-05-31/stored-vector-rows.jsonl")
    source = Path("dist/daily-production-runs/2026-05-31/load-audit/merged-jsonl/object-embeddings.jsonl")
