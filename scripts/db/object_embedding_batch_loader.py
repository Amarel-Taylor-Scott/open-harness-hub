...
Backs ``tool/object-embedding-batch-loader`` (catalog/tools/backend/
...
the canonical schema dimension defined once in ``scripts/_config.py``
...
# Canonical pgvector dimension is defined once in scripts/_config.py; never
# re-type the integer here (docs/codex/no-magic-values.md).
