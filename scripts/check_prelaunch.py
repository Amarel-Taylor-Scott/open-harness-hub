...
CLI:
    python3 scripts/check_prelaunch.py --self-test
    python3 scripts/check_prelaunch.py            # print the readiness report; exit 1 if not ready
"""
...
_DEMO_COPY = ("web/baltor/demo-console.html", "web/baltor/reviews.html", "docs/deployment/demo-console.md")
...
def assess() -> dict:
    pii: list[str] = []
    for p in _iter_files(_REPO / "demo-data"):
        try:
    ...
    detrack = [d for d in DETRACK_CANDIDATES if (_REPO / d).exists()]
