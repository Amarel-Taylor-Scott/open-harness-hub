...
_FIXTURE = _REPO / "fixtures" / "repo_intel" / "weekly_github_trend_watch_sample.json"
...
_HUB_ARTIFACT = {"openskillshub": "skill", "opentoolshub": "tool", "openharnesshub": "harness",
...
def fit_score(repo: dict, classification: dict) -> dict:
    ...
    return {"teleon": "teleon" in hubs, "baltor": "baltor" in hubs,
            "open_hub": bool(hubs & {"openskillshub", "opentoolshub", "openharnesshub", "opencontexthub", "shared-template-registry"}),
