...
CLI:
    python3 scripts/baltor_acceptance.py             # human report; exit 0 iff the product works
    python3 scripts/baltor_acceptance.py --self-test # assert the expected end-to-end outcomes
"""
