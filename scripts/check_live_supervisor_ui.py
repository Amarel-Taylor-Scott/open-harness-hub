...
CLI: PYTHONPATH=. python3 scripts/check_live_supervisor_ui.py --self-test
"""
...
_PAGE = _REPO / "web" / "baltor" / "fleet.html"
...
def _self_test() -> int:
    ...
    srv = (_REPO / "scripts" / "baltor_admin_demo_server.py").read_text()
