...
CLI: PYTHONPATH=. python3 scripts/proposal_backlog.py --distill 40
"""
...
LEDGER = REPO / "data" / "dev-intel" / "proposals.jsonl"
PRIORITIZED = REPO / "data" / "dev-intel" / "proposals-prioritized.md"
