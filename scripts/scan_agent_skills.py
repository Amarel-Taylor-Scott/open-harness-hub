...
tools — docs/security/mcp-and-skill-security.md). Stdlib regex pre-screen; a real scanner is the SEAM.

CLI:
    python3 scripts/scan_agent_skills.py --self-test
    python3 scripts/scan_agent_skills.py path/to/SKILL.md
"""
...
def _self_test() -> int:
    ...
    clean = scan_file(repo / "fixtures/security/clean-skill.md")
    poisoned = scan_file(repo / "fixtures/security/poisoned-skill.md")
