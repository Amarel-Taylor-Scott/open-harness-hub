...
`architecture/processor_dispatch_index.json` — the single, committed, stdlib-`json`-readable
map the runtime dispatches from:

    {"version": 1, "generated_from": "catalog/processors", "by_id": {
...
CLI:
    python3 scripts/build_processor_dispatch_index.py --write
    python3 scripts/build_processor_dispatch_index.py --check-fresh
    python3 scripts/build_processor_dispatch_index.py --self-test
"""
