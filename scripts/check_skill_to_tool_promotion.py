...
_CATALOG = _REPO / "architecture" / "skill_to_tool_promotion_catalog.json"
_DOC = _REPO / "docs" / "research" / "skillclaw-skill-to-deterministic-tool.md"
_SELF = _REPO / "scripts" / "check_skill_to_tool_promotion.py"
