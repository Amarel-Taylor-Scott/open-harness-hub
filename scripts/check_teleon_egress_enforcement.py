...
COVERED_EGRESS_CALLERS = (
    REPO / "scripts" / "context_workers" / "workers" / "tool_adapters.py",
    REPO / "scripts" / "context_workers" / "workers" / "node_research.py",
    REPO / "src" / "teleon" / "inference" / "adapters.py",
)
APPROVED_TRANSPORT = REPO / "src" / "teleon" / "egress" / "transports.py"
...
def _deny_by_default_violations() -> list[str]:
    ...
    problems: list[str] = []
    workers_dir = REPO / "scripts" / "context_workers" / "workers"
