"""check_teleon_adjacent_extended — proof for architecture/teleon_adjacent_extended.json.
...
Deterministic, offline, stdlib only. Run: PYTHONPATH=. python3 scripts/check_teleon_adjacent_extended.py --self-test
"""
...
_DOC = _REPO / "architecture" / "teleon_adjacent_extended.json"
