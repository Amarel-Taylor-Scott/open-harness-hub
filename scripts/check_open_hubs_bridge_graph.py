...
→ OpenHarnessHub (proof) → Teleon (runs) → Baltor (governs truth). Sources:
architecture/open_hubs_bridge_graph.json + architecture/company_portfolio_map.json.
...
_OPEN_HUBS = {"opencontexthub", "openskillshub", "opentoolshub", "openharnesshub",
