...
Stdlib + PyYAML + jsonschema (repo deps). CLI:
    python3 scripts/validate_flywheel_workflows.py --self-test
    python3 scripts/validate_flywheel_workflows.py            # validate + print results
"""
...
WORKFLOW_DIR = _REPO / "workflows"
WORKFLOW_SCHEMA = _REPO / "schemas" / "workflow" / "flywheel-workflow.schema.json"
