...
_FX = json.loads((_REPO / "fixtures" / "sales" / "chatbot_transcript_synthetic.json").read_text())
...
def _self_test() -> int:
    ...
    modes = json.loads((_REPO / "architecture" / "sales_diagnostic_modes.json").read_text())
