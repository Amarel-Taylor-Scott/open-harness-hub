#!/usr/bin/env python3
"""Generate docs/catalog/*.md pages from catalog rows or seed manifests.
...
Usage:
  ...
  python scripts/build_catalog_pages.py --row-dir dist/catalog-db-export-rows
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    DOCS = args.output_dir if args.output_dir.is_absolute() else ROOT / args.output_dir
