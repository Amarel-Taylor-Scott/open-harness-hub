...
Deterministic, offline. Models scripts/check_no_consumption_bypass.py.

CLI: python3 scripts/check_supermemory_no_truth_bypass.py --self-test
"""
...
_HANDLER = _REPO / "scripts" / "api_memory_handler.py"
