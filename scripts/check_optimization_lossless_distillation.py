...
CLI: PYTHONPATH=. python3 scripts/check_optimization_lossless_distillation.py --self-test
"""
...
RR = _load_isolated("baltor_distillation_retention_report_opt", "src/baltor/distillation/retention_report.py")
