"""check_registry_populate — proof for the dogfood population pipeline (src/teleon/registry/populate.py + tools/web_fetch.py).
...
from src.teleon.registry.populate import populate, repo_to_record  # noqa: E402
...
def main() -> int:
    ...
    ck("repo_to_record deterministic", repo_to_record("a/b") == repo_to_record("a/b"))
