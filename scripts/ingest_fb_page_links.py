...
discovery != trust: every repo is a candidate, license-checked before adoption. serves_truth=false. No PII.
  ...
  python3 scripts/ingest_fb_page_links.py --file post.txt        # extract repos from pasted post text
  echo "<post text>" | python3 scripts/ingest_fb_page_links.py --stdin
  python3 scripts/ingest_fb_page_links.py --self-test
"""
