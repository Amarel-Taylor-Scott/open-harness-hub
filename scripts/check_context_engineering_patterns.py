...
course (architecture/context_engineering_patterns.json). The four patterns it teaches (plan-tracking, context
...
CLI: PYTHONPATH=. python3 scripts/check_context_engineering_patterns.py --self-test
"""
