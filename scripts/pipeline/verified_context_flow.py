...
This is the north-star product (``docs/codex/north-star.md``) demonstrated in a
...
What is REAL here vs the SEAM (honest, per ``docs/codex/change-verification-contract.md``):
...
mapping per ``docs/architecture/component-execution-and-runtime-routing.md`` §4):
...
a stale internal claim, no model, no network):
    python3 scripts/pipeline/verified_context_flow.py
...
# (``python3 scripts/pipeline/verified_context_flow.py``). This orchestrator's
