...
Reads gap candidates (data/capability-gaps/*.jsonl) and emits, for each:
  * a VALID catalog knowledge-pack manifest (catalog/knowledge-packs/esoteric/)
...
OUT_KP = ROOT / "catalog" / "knowledge-packs" / "esoteric"
OUT_SEED = ROOT / "data" / "esoteric-packs"
VOCAB = ROOT / "vocabularies" / "industries.yaml"
