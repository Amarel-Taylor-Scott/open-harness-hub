...
CLI:
    python3 scripts/alias_resolver.py --self-test
    python3 scripts/alias_resolver.py stage.anti_fragility --audience security
"""
...
CANONICAL_TERMS = _REPO / "data" / "presentation" / "canonical-terms.yaml"
ALIAS_PACK_DIR = _REPO / "data" / "alias-packs"
ALIAS_PACK_SCHEMA = _REPO / "schemas" / "presentation" / "alias-pack.schema.json"
