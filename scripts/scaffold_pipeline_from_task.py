...
Usage:
    ...
    python3 scripts/scaffold_pipeline_from_task.py --hybrid "Detect human-trafficking signals in UGC posts with Gemma 4"
    python3 scripts/scaffold_pipeline_from_task.py --json "..."          # JSON output for agent consumption
    python3 scripts/scaffold_pipeline_from_task.py "..." --draft-yaml    # YAML draft to disk
