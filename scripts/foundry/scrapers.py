...
DEFAULT_REGISTRY = REPO / "data" / "source-registry.jsonl"   # gap-keywords → authoritative source
_MAX_FACTS = 200
_USER_AGENT = "OpenHarnessHub-foundry-scraper/1.0 (+https://openharnesshub.com)"
