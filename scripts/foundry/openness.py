...
Operationalizes the open-core boundary (`docs/strategy/open-core-model.md`) so the
...
# OpenHarnessHub account (a government entity / public authority / standards body).
...
def _self_test() -> int:
    ...
    check("EU-public grep Conditional ⇒ open", r["tier"] == TIER_OPEN, str(r))
