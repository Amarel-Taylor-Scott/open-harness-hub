...
eight modular stages (``docs/architecture/evidence-driven-component-factory.md``).
...
# never a flat "generated" number (docs/codex/master-goal.md).
...
PRIMITIVE_BY_TYPE: dict[str, str] = {
    ...
    "rule-pack": "Conditional",
    "logic-pack": "Conditional",
    "persona": "Action",
    "tool": "Action",
    "processor": "Action",
    "harness": "Action",
...
def _self_test() -> int:
    ...
    check("primitive map has rule-pack=Conditional", PRIMITIVE_BY_TYPE["rule-pack"] == "Conditional")
