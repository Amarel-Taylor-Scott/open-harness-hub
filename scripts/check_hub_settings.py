...
CLI: PYTHONPATH=. python3 scripts/check_hub_settings.py --self-test
"""
...
def _self_test() -> int:
    from src.openharnesshub.hub_settings import HubSettings, load_settings, all_settings, tools_for
