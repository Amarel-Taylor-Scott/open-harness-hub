...
The composition (every step a real `scripts/processors` callable, in order):
...
Run:  python3 scripts/showcase_pipelines/regulated_fact_qa.py
      python3 scripts/showcase_pipelines/regulated_fact_qa.py --self-test
"""
