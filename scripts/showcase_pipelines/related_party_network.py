...
Composition (real `scripts/processors` callables + deterministic identifier-graph clustering):
...
Run:  python3 scripts/showcase_pipelines/related_party_network.py [--self-test]
"""
