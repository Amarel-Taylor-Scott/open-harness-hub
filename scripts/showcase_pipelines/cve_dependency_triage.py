...
Composition (real `scripts/processors` callables + deterministic version arithmetic):
...
Run:  python3 scripts/showcase_pipelines/cve_dependency_triage.py [--self-test]
"""
