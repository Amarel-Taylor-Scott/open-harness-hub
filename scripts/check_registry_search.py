"""check_registry_search — proof for federated registry search (src/teleon/registry/search.py).
...
from src.teleon.registry.search import build_capability, improve, search_all, troubleshoot  # noqa: E402
