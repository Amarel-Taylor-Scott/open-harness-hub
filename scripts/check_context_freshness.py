...
Two rots that accumulate silently:
  ...
  --self-test   detector works + the CANONICAL docs (CLAUDE.md, AGENTS.md, docs/NORTHSTAR.md) have 0 broken refs (live guard)
  --check       report broken refs + un-archived superseded across docs/
"""
...
CANONICAL = ("CLAUDE.md", "AGENTS.md", "docs/NORTHSTAR.md", "docs/BIBLE.md")
