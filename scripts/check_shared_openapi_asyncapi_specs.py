...
(docs/contracts/{openapi,asyncapi}.generated.json) are a faithful, drift-free, projection-only machine view of
architecture/contract_registry.json — every registered HTTP route and every command/event/log channel is covered,
