#!/usr/bin/env python3
"""scripts.check_template_catalog — proof: architecture/template_catalog.json is well-formed + buildable.
...
CLI: python3 scripts/check_template_catalog.py --self-test
"""
