...
architecture/brand.json is the ONE source of the parent brand name + tagline + domain (no-magic-values). This
proof asserts:
...
_BRAND = _REPO / "architecture" / "brand.json"
_PMAP = _REPO / "architecture" / "company_portfolio_map.json"
