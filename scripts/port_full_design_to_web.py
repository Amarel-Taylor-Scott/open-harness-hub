...
Targets (the wired apps):            web/context-is-everything/ · web/baltor/ · web/openhubforai/
...
PATCHES: dict[str, dict[str, list[tuple[str, str]]]] = {
    ...
    "openhubforai": {
        ...
        "proto-catalog.jsx": [
            ...
            # hydrates the design's COMPONENTS/BY_SLUG globals (web/openhubforai/openhub-live.js).
            (
        ...
        "proto-pages-build.jsx": [
            # PPreview kicks the REAL /api/build (web/openhubforai/openhub-live.js) and re-renders
...
EXTRA_ENTRY_SCRIPTS = {"openhubforai": ["openhub-live.js"], "teleon": ["teleon-live.js"]}
...
APPS: dict[str, dict] = {
    ...
    "openhubforai": {
        "folder": "openhubforai",
        "entry": "OpenHubForAI Prototype.html",
        "code": [
...
def self_test() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            ck("openhubforai: openhub-live.js wired into the entry",
               'src="openhub-live.js"' in (WEB / "openhubforai" / "index.html").read_text(encoding="utf-8"))
