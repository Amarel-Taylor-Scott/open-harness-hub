...
CLI:
  python3 scripts/loop_prompt_builder.py --emit        # print the next-cycle prompt (what the runner/hook feeds)
  python3 scripts/loop_prompt_builder.py --self-test    # prove the emitted prompt carries every invariant
"""
...
STANDING_CONSTRAINTS = (
    ...
    "runtime); architectural law Baltor->Teleon->OpenHarnessHub never reverse (Teleon must NEVER import Baltor); "
