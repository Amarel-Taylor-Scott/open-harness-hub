...
offline. Stdlib + jsonschema. CLI:
    python3 scripts/check_gold_pack_contract.py --self-test
    python3 scripts/check_gold_pack_contract.py fixtures/context/gold-pack.example.json
"""
...
PACK_SCHEMA = _REPO / "schemas" / "context-pack.schema.json"
