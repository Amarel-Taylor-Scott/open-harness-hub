...
Self-test includes negative cases. Stdlib + jsonschema + PyYAML. CLI:
    python3 scripts/validate_tool_evidence_cards.py --self-test
"""
...
CARDS_DIR = _REPO / "data" / "tool-evidence-cards"
CARD_SCHEMA = _REPO / "schemas" / "backend" / "tool-evidence-card.schema.json"
BACKEND_TOOLS = _REPO / "data" / "backend-tools.yaml"
