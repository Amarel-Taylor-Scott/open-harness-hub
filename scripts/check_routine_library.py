#!/usr/bin/env python3
"""scripts.check_routine_library — proof: architecture/routine_library.json is well-formed. Every routine
...
CLI: python3 scripts/check_routine_library.py --self-test
"""
...
_LIB = _REPO / "architecture" / "routine_library.json"
