...
CLI: PYTHONPATH=. python3 scripts/check_information_retention_report.py --self-test
"""
...
RR = _load_isolated("baltor_distillation_retention_report", "src/baltor/distillation/retention_report.py")
