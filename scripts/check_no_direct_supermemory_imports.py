...
Deterministic, stdlib-only, offline. Models scripts/check_no_direct_external_imports.py.

CLI: python3 scripts/check_no_direct_supermemory_imports.py --self-test
"""
...
_APPROVED_STUB_PATHS = (
    "src/baltor/adapters/memory/supermemory_api.py",
    "src/baltor/adapters/memory/mcp_supermemory.py",
...
_SCAN_DIRS = ("scripts", "src/baltor", "web")
