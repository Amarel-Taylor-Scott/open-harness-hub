...
(scripts/acquisition/gap_screen.py) to estimate `expected_lift` WITHOUT collecting
anything, feeds that into the cell value function
(scripts/acquisition/cell_priority.py), and prints the ranked queue. High-likelihood
...
DEFAULT_QUEUE = ROOT / "data" / "research-queue" / "areas.jsonl"
