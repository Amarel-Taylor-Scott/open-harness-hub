...
CLI: python3 scripts/check_pipeline_pages_full_stack.py --self-test
"""
...
_PIPE = _REPO / "web" / "baltor" / "pipeline"
...
def _self_test() -> int:
    ...
    check("shared design system web/baltor/pipeline/pipeline.css exists", css.exists())
