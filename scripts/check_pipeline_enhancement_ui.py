#!/usr/bin/env python3
"""scripts.check_pipeline_enhancement_ui — proof (C-PIPE-ENH-UI): web/baltor/pipeline/enhancement.html is a
...
CLI: python3 scripts/check_pipeline_enhancement_ui.py --self-test
"""
...
_PAGE = _REPO / "web" / "baltor" / "pipeline" / "enhancement.html"
...
def _self_test() -> int:
    ...
    check("web/baltor/pipeline/enhancement.html exists", _PAGE.exists())
    if not _PAGE.exists():
