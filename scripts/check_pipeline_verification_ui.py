#!/usr/bin/env python3
"""scripts.check_pipeline_verification_ui — proof (D-PIPE-VER-1): web/baltor/pipeline/verification.html is a
...
Static source scan — deterministic, offline. CLI: python3 scripts/check_pipeline_verification_ui.py --self-test
"""
...
_PAGE = _REPO / "web" / "baltor" / "pipeline" / "verification.html"
...
def _self_test() -> int:
    ...
    check("web/baltor/pipeline/verification.html exists", _PAGE.exists())
    if not _PAGE.exists():
