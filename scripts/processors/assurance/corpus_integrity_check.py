...
``catalog/processors/assurance/corpus-integrity-check.yaml`` — process_kind ``verify.corpus_integrity``,
...
The verified-corpus-commons wedge (see ``docs/strategy/oracle-corpus-and-tooling-map.md``
...
CLI / self-test:
    python3 scripts/processors/assurance/corpus_integrity_check.py
