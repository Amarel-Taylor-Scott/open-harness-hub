...
``catalog/processors/assurance/multi-source-corroborate.yaml`` — process_kind
...
those values (one source of truth — see ``docs/codex/no-magic-values.md``).

This is the **change-verification-contract** idea turned into a runtime tool. The contract
(``docs/codex/change-verification-contract.md``) admits a change on *corroboration* — **>= 2
...
CLI / self-test:
    python3 scripts/processors/assurance/multi_source_corroborate.py
