...
USER_AGENT = (
    "OpenHarnessHubWalker/0.1 "
    "(+https://github.com/Amarel-Taylor-Scott/open-harness-hub; issues via repo)"
)
...
def run(
    ...
    Matches the manifest at `catalog/processors/wikipedia-category-walker.yaml`.
