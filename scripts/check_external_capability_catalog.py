...
CLI: python3 scripts/check_external_capability_catalog.py --self-test
"""
...
def _self_test() -> int:
    ...
    check("catalog declares its owning registry", catalog.get("owner_registry") == "src/baltor/runtime/registry/capability_registry.py")
