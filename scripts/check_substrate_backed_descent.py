...
architecture/model_index.json (via substrate_selector, reusing the model-index selector) and records WHICH model in
...
CLI: PYTHONPATH=. python3 scripts/check_substrate_backed_descent.py --self-test
"""
...
_REAL_INDEX = _REPO / "architecture" / "model_index.json"
