...
Asserts (against scripts.api_inference_handler.handle, the server source, and web/baltor/inference-plane.html):
  ...
  I. UI PROJECTION: web/baltor/inference-plane.html exists, fetches the inference endpoints, declares itself
...
def _self_test() -> int:
    ...
    src = (_REPO / "scripts" / "baltor_admin_demo_server.py").read_text(encoding="utf-8")
    ...
    ui_p = _REPO / "web" / "baltor" / "inference-plane.html"
