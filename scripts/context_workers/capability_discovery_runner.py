...
CLI:
    python3 scripts/context_workers/capability_discovery_runner.py --self-test
    python3 scripts/context_workers/capability_discovery_runner.py --once
    python3 scripts/context_workers/capability_discovery_runner.py --loop --interval 900   # owner-launched
"""
