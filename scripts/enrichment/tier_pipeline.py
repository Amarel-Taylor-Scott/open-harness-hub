...
CLI / self-test:
    python3 scripts/enrichment/tier_pipeline.py
...
# (``python3 scripts/enrichment/tier_pipeline.py``). The repo intentionally has
# no top-level ``scripts/__init__.py`` (it is a namespace package run via
...
#: mapping in docs/architecture/component-execution-and-runtime-routing.md §4:
