#!/usr/bin/env python3
"""scripts.check_standards_api — proof: the Standards API (scripts/api_standards_handler.py) is a pure,
...
(proven by snapshotting a temp dir and the repo's architecture/ dir before/after). Deterministic + offline.

CLI: python3 scripts/check_standards_api.py --self-test
"""
...
def _self_test() -> int:
    ...
    # 3) generate-preview is a DRY-RUN: it writes NO files. Snapshot a temp dir AND architecture/ before/after.
