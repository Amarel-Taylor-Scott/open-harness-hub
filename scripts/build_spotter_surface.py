...
the registry totals. serves_truth=false (a coaching surface, never an authority on truth). Offline + self-contained.
  ...
  python3 scripts/build_spotter_surface.py            # write dist/spotter/index.html
  python3 scripts/build_spotter_surface.py --self-test
"""
...
_OUT = _REPO / "dist" / "spotter" / "index.html"
_HEURISTICS = _REPO / "architecture" / "behavioral_heuristics.json"
_ONTOLOGY = _REPO / "architecture" / "registry_ontology.json"
