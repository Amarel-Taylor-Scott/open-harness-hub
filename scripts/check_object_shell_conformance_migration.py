...
_SAMPLES: dict[str, tuple[str, str, dict]] = {
    ...
    "HarnessArtifact": ("harness_artifact_id", "OpenHarnessHub:HarnessArtifact@logical", {
        ...
        "derived_from": ["harness://openharnesshub/source_handle_preservation", "rubric://openharnesshub/handle_validity"],
    ...
    "PurposeTaskRun": ("purpose_task_run_id", "Teleon:PurposeTaskRun@logical", {
        ...
        "scorecard_refs": ["scorecard://openharnesshub/source_handle_preservation@v1"],
    ...
    "EvaluationScorecard": ("eval_id", "OpenHarnessHub:EvaluationScorecard@logical", {
        ...
        "derived_from": ["harness://openharnesshub/source_handle_preservation@v1",
...
def _self_test() -> int:
    ...
    man = json.loads((_REPO / "architecture" / "object_shell_migration.json").read_text())
