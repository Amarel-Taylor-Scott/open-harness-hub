...
#: routes this handler owns (registered in architecture/contract_registry.json#api_routes).
...
def runtime_sections() -> tuple:
    m = json.loads((_REPO / "architecture" / "section_maturity_matrix.json").read_text())
