...
Reads architecture/teleon_demo_catalog.json, computes LIVE savings for the built ('live') demos from their real
...
CLI: PYTHONPATH=. python3 scripts/demo_dashboard.py --emit --print
"""
...
CATALOG = REPO / "architecture" / "teleon_demo_catalog.json"
OUT = REPO / "dist" / "teleon-demos" / "index.html"
