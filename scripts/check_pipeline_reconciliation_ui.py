#!/usr/bin/env python3
"""scripts.check_pipeline_reconciliation_ui — proof (C-PIPE-RECON-UI): web/baltor/pipeline/reconciliation.html
...
CLI: python3 scripts/check_pipeline_reconciliation_ui.py --self-test
"""
...
_PAGE = _REPO / "web" / "baltor" / "pipeline" / "reconciliation.html"
...
def _self_test() -> int:
    ...
    check("web/baltor/pipeline/reconciliation.html exists", _PAGE.exists())
    if not _PAGE.exists():
