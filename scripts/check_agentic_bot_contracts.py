...
(src/teleon/agents/agent_runtime_provider.py); OpenClaw/Hermes-style runtimes are CANDIDATES behind it, and
...
Asserts:
  ...
  D. REGISTERED: all 8 contracts are registered in architecture/contract_registry.json with the matching
     schema path.
...
_SCHEMA_DIR = _REPO / "schemas" / "agents"
