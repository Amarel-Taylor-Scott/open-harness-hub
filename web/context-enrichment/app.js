/* Context Enrichment (CEaaS) — standalone front-end SPA. Its OWN app (no shared front-end with Open
...
(function () {
  ...
  function header(active) {
    var nav = [["/", "Overview"], ["/pricing", "Pricing"], ["/trust", "Trust"]].map(function (p) {
