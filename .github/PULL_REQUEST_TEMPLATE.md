...
- [ ] New component (harness / pipeline / rule-pack / knowledge-pack / tool / processor / persona / adapter / rubric / dataset)
...
- [ ] If this PR adds a component: it has a `license` from an SPDX-compatible list (MIT, Apache-2.0, CC-BY-4.0, CC0-1.0, BSD-3-Clause, …)
- [ ] If this PR adds a component: industry / capability / modality tags come from the controlled vocabularies in `vocabularies/`
...
- [ ] If this PR adds a high-risk component: `eu_ai_act_risk: high_risk` is set so the Annex IV dossier is generated
