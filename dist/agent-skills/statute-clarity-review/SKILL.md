---
name: statute-clarity-review
description: 'Given the text of a statute, regulation, ordinance, or agency rule,
  produce a structured assessment of drafting quality and interpretation risk: per-section
  findings tagged with canon / failure category / severity / suggested redline, plus
  a rubric score against `rubric/statute-clarity-v1`.'
...
- **rule_packs**: `rule-pack/grep-statute-ambiguity-flags`
...
- Hub component: `pipeline/statute-clarity-review` v0.1.0
- License: `MIT`
