---
name: esg-pillar-deep-dive
description: Given a sustainability disclosure and a target pillar (E, S, or G), produce
  a SASB-industry-specific, ISSB/GRI/TCFD-aligned, framework- coded review with greenwashing-pattern
  scan and a rubric grade against `rubric/esg-pillar-depth-v1`.
...
- **persona**: persona/esg-pillar-analyst
- **model_adapter**: adapter/ollama-default
- **rule_packs**: `rule-pack/grep-greenwashing-flags`

## Success criteria

- rubric `rubric/esg-pillar-depth-v1` threshold 0.7

## Provenance

- Hub component: `pipeline/esg-pillar-deep-dive` v0.1.0
- License: `MIT`
