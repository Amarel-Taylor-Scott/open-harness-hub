...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/use-case-seed-row-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI cross-domain use-case seed surfaces, OpenHubForAI hybrid label and dimensional search architecture
