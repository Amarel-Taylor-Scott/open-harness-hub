...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/object-factory-worker-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI architecture notes
