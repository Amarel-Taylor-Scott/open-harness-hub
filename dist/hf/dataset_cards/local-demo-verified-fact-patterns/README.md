...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/local-demo-verified-fact-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: User-provided local demo and verified fact feed product direction from 2026-05-25, OpenHubForAI signed knowledge network architecture
