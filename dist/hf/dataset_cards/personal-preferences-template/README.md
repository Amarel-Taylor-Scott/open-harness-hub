...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/personal-preferences-template` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
License: `CC0-1.0`. Hub component: `knowledge-pack/personal-preferences-template`.
