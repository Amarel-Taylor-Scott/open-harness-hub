...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/database-component-store-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI north star platform architecture, OpenHubForAI Postgres schema
