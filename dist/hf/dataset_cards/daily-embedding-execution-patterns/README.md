...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/daily-embedding-execution-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI embedding execution planner, OpenHubForAI vector readiness audit, OpenHubForAI daily production runner
