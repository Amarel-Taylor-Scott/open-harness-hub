...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/component-layer-control-flow-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI Postgres schema, OpenHubForAI pipeline runner schema
