...
language:
- en
pretty_name: OpenHubForAI manifest shapes, schemas & conventions reference
---

# OpenHubForAI manifest shapes, schemas & conventions reference

<!-- Generated from OpenHubForAI manifest `knowledge-pack/manifest-shapes-and-conventions` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
@misc{manifest-shapes-and-conventions_open_harness_hub,
  title  = {OpenHubForAI manifest shapes, schemas & conventions reference},
