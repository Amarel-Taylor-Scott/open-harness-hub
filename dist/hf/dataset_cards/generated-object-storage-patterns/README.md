...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/generated-object-storage-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI primitive platform backend, OpenHubForAI Postgres schema, OpenHubForAI vector DB spec
