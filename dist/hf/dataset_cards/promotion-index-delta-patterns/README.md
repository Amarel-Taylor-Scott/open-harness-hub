...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/promotion-index-delta-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI candidate primitive promotion scoring, OpenHubForAI partitioned index delta architecture
