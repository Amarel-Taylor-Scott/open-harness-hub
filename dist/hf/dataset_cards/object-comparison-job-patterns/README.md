...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/object-comparison-job-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI object factory scaling architecture
