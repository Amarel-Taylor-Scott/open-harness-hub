...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/postgres-pgvector-bootstrap-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI low-cost hosting and generated object storage architecture
