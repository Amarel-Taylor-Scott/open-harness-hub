...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/hybrid-comparison-blocking-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI resumable object comparison planner, OpenHubForAI use-case seed entity and embedding bucket rows
