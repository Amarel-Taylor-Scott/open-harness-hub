...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/use-case-seed-embedding-bucket-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI use-case seed row exporter, OpenHubForAI resumable object comparison jobs architecture
