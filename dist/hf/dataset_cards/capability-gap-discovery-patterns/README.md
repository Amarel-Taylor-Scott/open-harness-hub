...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/capability-gap-discovery-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI capability gap discovery workflow, Kaggle datasets and competitions, arXiv API, Semantic Scholar API
