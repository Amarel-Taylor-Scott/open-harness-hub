...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/index-coverage-repair-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI daily production rows, OpenHubForAI model-ops daily run, OpenHubForAI promotion readiness planner
