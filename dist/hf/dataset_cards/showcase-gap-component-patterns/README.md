...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/showcase-gap-component-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI showcase candidate coverage report, OpenHubForAI use-case seed row exporter
