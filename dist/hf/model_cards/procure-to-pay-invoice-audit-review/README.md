...
<!-- Generated from OpenHubForAI manifest `harness/procure-to-pay-invoice-audit-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
