...
<!-- Generated from OpenHubForAI manifest `harness/rag-citation-audit-review` v0.1.0. Do not edit by hand; edit the source manifest and re-run `python scripts/emit/hf_model_card.py`. -->
