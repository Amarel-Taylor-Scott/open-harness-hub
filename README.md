...
| **Schemas** | schema | A typed I/O contract shared across components. |
...
Components are produced by the **foundry** (`scripts/foundry/`, 19 self-tested modules):
...
- **Catalog manifests (schema-validated): 2,633** — 766 committed to git, 1,867 machine-generated candidates pending review/promotion.
- **By type:** knowledge-packs 427 · pipelines 420 · rule-packs 402 · personas 233 · rubrics 223 · datasets 205 · harnesses 195 · tools 173 · processors 166 · benchmarks 111 · patterns 56 · adapters 20 · logic-packs 2.
