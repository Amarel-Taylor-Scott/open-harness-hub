...
_CATALOG_PATH = _REPO / "architecture" / "external_capability_catalog.json"
_HEALTH_PATH = _REPO / "architecture" / "repo_health_policy.json"
_MATRIX_PATH = _REPO / "architecture" / "repo_replacement_matrix.json"
_BACKEND_TOOLS_PATH = _REPO / "data" / "backend-tools.yaml"
