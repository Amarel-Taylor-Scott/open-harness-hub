"""src/baltor/workers/execution_providers/local_job_emulator.py — RE-EXPORT SHIM (lossless extraction → Teleon, 2026-06-08). Canonical home: src.teleon.workers.*. Baltor → Teleon allowed; Teleon never imports Baltor."""
