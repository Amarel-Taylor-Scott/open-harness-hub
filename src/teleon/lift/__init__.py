...
Load-bearing invariants (proven by scripts/check_teleon_lift.py):
...
check_portfolio_dependency_law). It reuses architecture/capability_runtime_classes.json (the runtime-class
