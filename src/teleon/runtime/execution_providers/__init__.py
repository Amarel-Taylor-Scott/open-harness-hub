...
extracted src/baltor/workers/execution_providers → here one module at a time, losslessly, with Baltor re-export
shims (architecture/portfolio_dependency_law.json migration_status). Teleon imports only Teleon/stdlib.
"""
