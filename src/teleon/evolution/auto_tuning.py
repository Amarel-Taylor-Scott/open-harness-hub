...
architecture/tunable_task_catalog.json. Pure + deterministic; the plan is evidence, never truth (serves_truth False).
"""
...
_CATALOG = Path(__file__).resolve().parents[3] / "architecture" / "tunable_task_catalog.json"
