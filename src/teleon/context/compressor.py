...
architecture/context_compression_provider_catalog.json; the prompt-layer sibling is evolution/token_reduction.py.
...
_CCR = _REPO / "data" / "ccr"          # reversible raw store (content-addressed; gitignored data/)
