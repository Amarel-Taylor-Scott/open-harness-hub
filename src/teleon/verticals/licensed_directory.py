...
pharmacist, …) by swapping THREE things from architecture/licensed_professions.json: the authoritative SOURCES, the
...
_REGISTRY = Path(__file__).resolve().parents[3] / "architecture" / "licensed_professions.json"
