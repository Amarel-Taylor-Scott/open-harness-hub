...
Same model, different providers, different price. Reads architecture/model_index.json entries (each row is a
...
_REPO = Path(__file__).resolve().parents[3]          # src/teleon/economics/ -> repo root
_MODEL_INDEX = _REPO / "architecture" / "model_index.json"
