...
architecture/capability_implementation_registry.json. A selection is evidence, never truth (serves_truth False).
"""
...
_REGISTRY = Path(__file__).resolve().parents[3] / "architecture" / "capability_implementation_registry.json"
