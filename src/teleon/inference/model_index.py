...
filters, ties broken toward higher quality, deterministic. Reads architecture/model_index.json (which consolidates
...
_INDEX_PATH = Path(__file__).resolve().parents[3] / "architecture" / "model_index.json"
STATUS_FRESH = "fresh"
