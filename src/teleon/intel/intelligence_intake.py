...
Reads architecture/intelligence_source_registry.json (RSS + official REST APIs, keyless or free-key, ToS-clean)
...
_REGISTRY = Path(__file__).resolve().parents[3] / "architecture" / "intelligence_source_registry.json"
