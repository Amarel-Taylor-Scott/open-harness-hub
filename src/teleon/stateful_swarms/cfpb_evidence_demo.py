...
def run_cfpb_evidence_demo(*, now: str, blackboard: LocalSqliteBlackboard | None = None,
    ...
    """
    bb = blackboard if blackboard is not None else LocalSqliteBlackboard(db_path=":memory:")
