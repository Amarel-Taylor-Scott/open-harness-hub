...
Why (scale review 2026-06-25, docs/architecture/scale-architecture-review-2026-06-25.md): the planned
...
moves/queries/indexes records; it is never itself a source of truth). Teleon layer — never imports baltor.
  ...
  PYTHONPATH=. python3 src/teleon/infra/scale_ports.py --self-test
  PYTHONPATH=. python3 src/teleon/infra/scale_ports.py --status
"""
