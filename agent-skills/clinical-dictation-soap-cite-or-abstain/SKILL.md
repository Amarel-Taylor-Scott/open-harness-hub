---
name: clinical-dictation-soap-cite-or-abstain
description: Given a clinician's free-text dictation, produce a structured SOAP note
  where every Assessment and Plan claim cites the guideline span or dictated finding
  that grounds it, with ambiguous acronyms disambiguated against context, or abstain
  on that claim. Publication is blocked unless citation coverage and the hallucination
...
- **knowledge_packs**: `knowledge-pack/clinical-acronym-sense-disambiguation`, `knowledge-pack/clinical-guidelines-sample`
- **rule_packs**: `rule-pack/phi-hipaa-en`, `rule-pack/clinical-red-flags`, `rule-pack/hybrid-retrieval-policy`
...
- Hub component: `pipeline/clinical-dictation-soap-cite-or-abstain` v0.1.0
- License: `MIT`
