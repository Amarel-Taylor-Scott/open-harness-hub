---
name: payer-claims-denial-audit-review
description: Review claim denials for policy basis, medical necessity, coding support,
  appeal rights, and turnaround evidence.
...
- **persona**: persona/payer-denial-auditor
- **model_adapter**: adapter/ollama-default
- **knowledge_packs**: `knowledge-pack/payer-claims-denial-audit-frameworks`
- **rule_packs**: `rule-pack/grep-payer-claims-denial-audit-flags`, `rule-pack/rag-payer-claims-denial-audit-retrieval-policy`

## Success criteria

- rubric `rubric/payer-claims-denial-audit-quality-v1` threshold 0.7
- deterministic `$.steps.redaction_audit.output.result.pass` == `True`
- deterministic `$.steps.check_citations.output.result.pass` == `True`

## Provenance

- Hub component: `pipeline/payer-claims-denial-audit-review` v0.1.0
- License: `MIT`
