---
name: mine-safety-incident-review
description: Review mine safety incident packets for hazard controls, preshift evidence,
  training, equipment condition, and corrective action.
...
- **persona**: persona/mine-safety-reviewer
- **model_adapter**: adapter/ollama-default
- **knowledge_packs**: `knowledge-pack/mine-safety-incident-frameworks`
- **rule_packs**: `rule-pack/grep-mine-safety-incident-flags`, `rule-pack/rag-mine-safety-incident-retrieval-policy`

## Success criteria

- rubric `rubric/mine-safety-incident-quality-v1` threshold 0.7
- deterministic `$.steps.redaction_audit.output.result.pass` == `True`
- deterministic `$.steps.check_citations.output.result.pass` == `True`

## Provenance

- Hub component: `pipeline/mine-safety-incident-review` v0.1.0
- License: `MIT`
