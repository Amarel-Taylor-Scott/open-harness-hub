...
services/
  ...
  products/
    harness_hub/entrypoint.py        Open Harness Hub (request) — serves web/harness-hub/ (OH_PRODUCT pin)
    context_enrichment/entrypoint.py Context Enrichment / CEaaS (request) — serves web/context-enrichment/
