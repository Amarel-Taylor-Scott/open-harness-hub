...
const TOOLS = [
  ...
  },
  {
    ...
    "description": "Jointly encode query+doc to rescore the fused top-50\u2192100 and keep the top-5 \u2014 the single highest-precision lever in the pipeline (~40%+ recall@k / MRR lift); cost is bounded by candidate count, not corpus size. Open-weight (bge-reranker-v2-m3) is commercial-safe.\n\nRetrieval/prompt taxonomy step R3 (see docs/concepts/retrieval-and-prompt-taxonomy.md). One swappable method-component for the governed-model-call recipe; lift is measured at the pipeline level, not on this component.",
    "inputSchema": {
      "type": "object",
      "additionalProperties": false
    },
...
const HANDLERS: Record<string, (args: any) => Promise<unknown>> = {
  ...
  "bigquery-cold-tier-export-planner": async (args: any) => {
  ...
  "approved-component-promotion-planner": async (args: any) => {
  ...
  "postgres-pgvector-bootstrap-planner": async (args: any) => {
  ...
  "specialized-model-card-scan-job-emitter": async (args: any) => {
  ...
  "page-to-markdown-converter": async (args: any) => {
  ...
  "primitive-source-surface-scanner": async (args: any) => {
  ...
  "component-local-postgres-smoke-planner": async (args: any) => {
  ...
  "edge-micro-model-authorization-router": async (args: any) => {
  ...
  "generative-media-router": async (args: any) => {
  ...
  "grounded-multimodel-verification-gate": async (args: any) => {
  ...
  "use-case-seed-embedding-bucket-exporter": async (args: any) => {
  ...
  "daily-embedding-execution-batch-planner": async (args: any) => {
  ...
  "use-case-seed-entity-ref-exporter": async (args: any) => {
  ...
  "search-provider-router": async (args: any) => {
  ...
  "daily-thousand-component-seed-generator": async (args: any) => {
  ...
  "sentence-to-pipeline-blueprint-runner": async (args: any) => {
  ...
  "staged-vs-committed-load-auditor": async (args: any) => {
  ...
  "worker-output-merge-auditor": async (args: any) => {
  ...
  "specialized-model-card-row-emitter": async (args: any) => {
  ...
  "prompt-master-prompt-optimizer": async (args: any) => {
  ...
  "daily-promotion-readiness-planner": async (args: any) => {
  ...
  "candidate-primitive-promotion-scorer": async (args: any) => {
  ...
  "multimodal-safety-screen": async (args: any) => {
  ...
  "source-surface-execution-summary-reporter": async (args: any) => {
  ...
  "approved-promotion-smoke-planner": async (args: any) => {
  ...
  "curriculum-qa-dataset-builder": async (args: any) => {
  ...
  "compression-fidelity-check": async (args: any) => {
  ...
  "gemma-primitive-graph-tagger": async (args: any) => {
