...
LOCKED brand architecture (`docs/strategy/brand-architecture.md`).
...
- [x] Third site built — `web/context-is-everything/` (parent landing) + registered in `services/registry.yaml` (:8002).
