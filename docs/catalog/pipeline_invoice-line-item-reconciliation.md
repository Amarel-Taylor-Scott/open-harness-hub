...
*pipeline* · `pipeline/invoice-line-item-reconciliation` · v0.1.0 · experimental
...
| 10 | `escalate_on_discrepancy` | processor | `processor/escalate-human-review` | $.steps.verify_foots_to_total.output.pass == false |
