...
*pipeline* · `pipeline/ph-covered-transaction-screening` · v0.1.0 · experimental
...
| 10 | `escalate` | processor | `processor/escalate-human-review` | $.steps.sanctions_screen.output.matches != [] || $.steps.typology_score.output.max_severity == 'high' |
