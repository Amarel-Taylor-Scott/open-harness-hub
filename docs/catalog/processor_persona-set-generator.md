# Persona-set generator (STORM)

*processor* · `processor/persona-set-generator` · v0.1.0 · experimental

Spawn N personas with distinct perspectives on a topic. Used by
