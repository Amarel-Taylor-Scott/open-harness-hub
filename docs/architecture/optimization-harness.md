...
`scripts/runtime/optimization.py`. Every optimizer is a swappable wrapper behind ONE stable contract so they
...
Proof: `scripts/check_optimization_suite.py` (snapshot determinism · ≥6 variants · bake-off promotes some & rejects
