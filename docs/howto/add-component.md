...
Every manifest starts with the [common envelope](../reference/spec.md#30-common-envelope-all-component-types).
Beyond that, see the schema for your component type in `schemas/`.
...
- **Trust boundaries travel with the component**, not the deployment.
