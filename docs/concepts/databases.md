...
| MongoDB / Couchbase / Firestore | "Give me the full manifest of one component." | [`db/mongodb/collections.md`](https://github.com/TaylorAmarelTech/open-harness-hub/blob/main/db/mongodb/collections.md) |
