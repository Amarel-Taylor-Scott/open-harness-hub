...
`scripts/pattern_miner.py` scans `scripts/`, `src/baltor/`, `architecture/`, `schemas/`,
`web/baltor/`, and `docs/` and grades what it finds against the registry. It is deterministic and
