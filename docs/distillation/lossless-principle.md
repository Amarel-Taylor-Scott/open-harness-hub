...
Standing law: `docs/codex/lossless-distillation.md`. Engine: `src/baltor/distillation/lossless_store.py`.
...
```bash
PYTHONPATH=. python3 scripts/check_lossless_artifact_store.py --self-test
