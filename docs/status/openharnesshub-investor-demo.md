# OpenHarnessHub.io — investor demo (public URL, fully wired)
...
`ohh-live-browse.png`, `ohh-live-detail.png` · journey video: `artifacts/e2e/videos/journey-1-openharnesshub.mp4`.
