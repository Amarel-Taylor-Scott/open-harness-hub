...
`web/openhubforai/index.html` and `web/baltor/index.html` are **GENERATED by
...
- **Root cause:** the design-port regeneration **superseded** the old per-file script wiring. The old
  ...
  **already failing at the committed HEAD** (confirmed: `git show HEAD:web/openhubforai/index.html` does
