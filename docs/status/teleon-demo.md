...
- Local: `http://127.0.0.1:8003/` (`teleon_app` in `architecture/local_service_registry.json`,
  `OH_PRODUCT=teleon` → `web/teleon/`, transplanted by `scripts/port_full_design_to_web.py`)
