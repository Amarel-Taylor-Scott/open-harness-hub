...
values is [`architecture/brand.json`](../../architecture/brand.json) — this doc is the *narrative
...
| Short tagline | — | **Context. Capability. Proof.** |
| Developer tagline | — | **The platform for governed agentic work.** |
