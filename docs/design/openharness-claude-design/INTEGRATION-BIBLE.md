...
> The backend counterpart to `DESIGN-BIBLE.md`. The DESIGN-BIBLE standardizes the UI (one shared kit, the
...
| `/registry/...` | registry / catalog projection | `local_openhub_projection_api` (9423) | `OH_SEAM_REGISTRY_BASE` |
...
- References: `docs/architecture/fly-deploy-runbook.md`, `docs/architecture/service-auth-and-consumption-model.md`,
  `docs/architecture/surface-deploy.md`.
...
- Read order for an engineer/designer wiring a surface: this file -> `DESIGN-BIBLE.md` (the UI) ->
