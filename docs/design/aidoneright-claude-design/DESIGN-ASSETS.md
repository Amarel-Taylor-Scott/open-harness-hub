...
> verbatim. Read `DESIGN-BIBLE.md` for the guide and rules; this file is the code those rules describe. Pair it with
> `DESIGN-BIBLE.md` + `INTEGRATION-BIBLE.md` and you have the whole system, nothing external required.
>
...
(function (root) {
  ...
  const PRODUCTS = {
    ...
    openHarnessHub: {
      ...
      home: '../openharnesshub/OpenHubForAI Prototype.html',
    ...
    contextEnrichment: {
      ...
      supportedBy: { name: 'OpenHubForAI', short: 'OpenHubForAI', url: '../openharnesshub/OpenHubForAI Prototype.html' },
    },
  };
  ...
  const ENTITIES = {
    ...
    openHarnessHub: {
      ...
      accent: '#d2542f', glyph: '⎔', url: '../openharnesshub/OpenHubForAI Prototype.html', status: 'live',
    },
    openMCPHub: {
