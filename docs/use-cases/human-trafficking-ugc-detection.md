...
- Rule pack (GREP): [`rule-pack/grep-human-trafficking-ugc-flags`](https://github.com/Amarel-Taylor-Scott/open-harness-hub/blob/main/catalog/rule-packs/grep/human-trafficking-ugc-flags.yaml) (18 detectors, Polaris + ILO indicators)
- Rule pack (classifier): [`rule-pack/classifier-trafficking-signal`](https://github.com/Amarel-Taylor-Scott/open-harness-hub/blob/main/catalog/rule-packs/classifier/trafficking-signal-classifier.yaml) (10 Polaris typology slots)
...
- Pipeline: [`pipeline/gemma4-trafficking-ugc-triage`](https://github.com/Amarel-Taylor-Scott/open-harness-hub/blob/main/catalog/pipelines/platform-moderation/gemma4-trafficking-ugc-triage.yaml)
