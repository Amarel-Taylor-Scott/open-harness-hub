#!/usr/bin/env python3
"""scripts.check_{{adapter_name}}_adapter — proof of standard.provider_adapter.v1 for {{title}}.

GENERATED STUB (standard.proof_script.v1). Asserts the adapter satisfies the structural {{port_name}}
...
def _self_test() -> int:
    ...
    check("TODO: implement {{adapter_name}} adapter proof (standard.provider_adapter.v1)", False,
