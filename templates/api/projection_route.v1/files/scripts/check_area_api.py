#!/usr/bin/env python3
"""scripts.check_{{area}}_api — proof of standard.api_projection.v1 for {{title}}.

GENERATED STUB (standard.proof_script.v1). Drives the handler DIRECTLY (no socket): asserts the route is
...
def _self_test() -> int:
    ...
    check("TODO: implement {{area}} API proof (standard.api_projection.v1)", False,
