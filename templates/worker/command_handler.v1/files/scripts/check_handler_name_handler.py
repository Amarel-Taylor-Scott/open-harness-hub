#!/usr/bin/env python3
"""scripts.check_{{handler_name}}_handler — proof of standard.durable_command.v1 for {{title}}.

GENERATED STUB (standard.proof_script.v1). Asserts: idempotency_key is content-addressed (no wall-clock,
...
def _self_test() -> int:
    ...
    check("TODO: implement {{handler_name}} handler proof (standard.durable_command.v1)", False,
