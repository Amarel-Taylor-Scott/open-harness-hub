#!/usr/bin/env python3
"""scripts.check_{{page}}_ui — proof of standard.ui_projection for {{title}}.

GENERATED STUB (standard.proof_script). Asserts the page exists, references only the projection endpoint
