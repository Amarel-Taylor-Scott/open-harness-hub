...
|---|---|---|---|
| Atomic catalog unit | Skill folder | Skill folder | Harness, Pipeline, RulePack, KnowledgePack, LogicPack, Tool, Persona, Adapter, Rubric, Dataset, Processor, Schema, Benchmark, Pattern (**14 types**) |
