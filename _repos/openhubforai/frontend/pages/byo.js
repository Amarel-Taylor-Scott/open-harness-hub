/* OpenHubForAI — BYO module: Private Registry (/registry) + Connect/MCP (/connect)
   Ported faithfully from proto-byo.jsx. Vanilla ES5-style, no build, no imports.
   Registers via window.OpenHubForAI.register(). Reads shared data from ctx.data / ctx.PRIMS. */
(function () {
  "use strict";
    ...
    return (
      '<div class="pt-page wide pt-view">' +
        ...
        '<div class="pt-reg-cover">' +
          ...
          '<span style="font-size:11.5px;color:var(--fg-muted)">26% your IP · 74% from OpenHubForAI</span>' +
        "</div>" +
  ...
  function renderConnect(ctx) {
    ...
    var mcpConfig =
      '{\n  "mcpServers": {\n    ' +
      '<span class="tok">"openhubforai"</span>' +
      ": {\n      \"url\": \"https://mcp.openhubforai.ai/sse\",\n      \"scopes\": [" +
    ...
    var bridgeHtml =
      '<div class="pt-bridge">' +
        ...
        '<div class="pt-zone governed">' +
          '<div class="zh">OpenHubForAI<span class="tag">governed</span></div>' +
    ...
    var dashGrid =
      '<div class="pt-dash-grid">' +
        ...
        '<div class="pt-panel">' +
          '<div class="oh-cc-id mono" style="margin-bottom:4px">OpenHubForAI as an MCP server</div>' +
        ...
        '<div class="pt-panel">' +
          ...
          '<p style="font-size:12.5px;color:var(--fg-muted);margin:0 0 8px;line-height:1.5">Register local servers OpenHubForAI agents query to ground answers — data stays local.</p>' +
          '<div class="pt-srv">' +
    ...
    return (
      '<div class="pt-page wide pt-view">' +
        '<div class="pt-page-head">' +
          ...
          '<div class="sub">Keep proprietary context in your environment. Your agents source it locally and call OpenHubForAI over MCP to fill the gaps — only queries &amp; governed components cross the line, never your data.</div>' +
        "</div>" +
        bridgeHtml +
        crossLine +
        dashGrid +
  ...
  window.OpenHubForAI.register("/registry", renderRegistry, onMountRegistry, { theme: "dark" });
  window.OpenHubForAI.register("/connect",  renderConnect,  onMountConnect,  { theme: "dark" });
