  ...
  return (
    <div className="pt-page wide pt-view">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '13px 16px', marginBottom: 16, border: '1px solid var(--line)', borderLeft: '3px solid var(--accent)', borderRadius: 'var(--r-md)', background: 'var(--accent-weak)' }}>
        ...
        <a className="oh-btn oh-btn--ghost oh-btn--sm" href="../context-enrichment/Context Enrichment.html">Open Baltor →</a>
      </div>
...
function PSignin() {
  ...
  return <OhAuth brand={{ name: 'OpenHubForAI', realm: 'openhubforai', tld: '.io', glyph: '⎔', accent: 'var(--accent)' }} mode={mode} />;
}
