# AIDONERIGHT-UNIVERSE — how `openhubforai` interfaces with the rest of the AI Done Right org
...
## This repo — `openhubforai` (`aidoneright-openhubforai`)
- **Layer:** product · **Kind:** open_spec
- **Role:** the OPEN ecosystem + the open CapabilityTask spec (CTS). The neutral home of the standard; stays product-neutral.
- **How others interface with you:** Consume the open CapabilityTask spec + conformance tests; its backend also answers a same-origin seam.
...
| `openhubforai` **← you** | aidoneright-openhubforai | product | spec | the OPEN ecosystem + the open CapabilityTask spec (CTS). The neutral home of the standard; stays product-neutral. |
