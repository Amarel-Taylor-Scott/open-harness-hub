...
def default_plugins() -> list[Plugin]:
    """A finder per hub, DERIVED from _repos/shared-backend-components/architecture/hub_population_strategy.json (single source: add a hub to the
    ...
    try:
        ...
        strat = json.loads((_resource("architecture") / "hub_population_strategy.json")
