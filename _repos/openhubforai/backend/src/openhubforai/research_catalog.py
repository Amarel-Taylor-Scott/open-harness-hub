...
Two single sources: _repos/shared-backend-components/architecture/research_component_catalog.json (the components) + _repos/shared-backend-components/architecture/research_guardrail_policy.json
...
_CATALOG = _resource("architecture") / "research_component_catalog.json"
_GUARDRAILS = _resource("architecture") / "research_guardrail_policy.json"
