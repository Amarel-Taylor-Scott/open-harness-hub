# AIDONERIGHT-UNIVERSE — how `pitch-decks` interfaces with the rest of the AI Done Right org
...
## This repo — `pitch-decks` (`aidoneright-pitch-decks`)
...
| `pitch-decks` **← you** | aidoneright-pitch-decks | business | read | CONTEXT repo — investor pitch decks, investment narrative, one-pagers, traction/metrics evidence. The outward-facing… |
