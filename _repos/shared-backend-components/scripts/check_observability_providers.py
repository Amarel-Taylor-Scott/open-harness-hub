"""check_observability_providers — proof for _repos/shared-backend-components/architecture/observability_providers.json (backs registry #33).
...
_DOC = _resource("architecture") / "observability_providers.json"
