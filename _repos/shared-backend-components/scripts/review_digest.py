...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/review_digest.py --report
"""
...
DIGEST = _resource("data") / "dev-intel" / "review-digest.md"
...
def compute_digest() -> dict:
    ...
    recording = (_resource("scripts") / "check_recording_readiness.py").exists()
