...
The admin API server (`_repos/shared-backend-components/scripts/baltor_admin_demo_server.py`) used `cgi.FieldStorage`, which was
...
CLI:
    python3 _repos/shared-backend-components/scripts/check_admin_server.py --self-test
"""
