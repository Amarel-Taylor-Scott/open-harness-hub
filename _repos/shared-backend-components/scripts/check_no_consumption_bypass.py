...
(2) the ContextResponse truth object is CONSTRUCTED only in _repos/shared-backend-components/scripts/runtime/consumption.py within the governed
...
CLI: python3 _repos/shared-backend-components/scripts/check_no_consumption_bypass.py --self-test
"""
...
def _self_test() -> int:
    ...
    runtime_dir = _resource("scripts/runtime")
    ...
    src = (_resource("scripts/runtime/consumption.py")).read_text(encoding="utf-8")
