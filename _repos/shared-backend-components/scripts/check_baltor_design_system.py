...
Asserts:
  ...
  F. SPEC PERSISTED: the design spec is durable in-repo (_repos/shared-backend-components/docs/design/aidoneright-claude-design: FAMILY-README +
...
def _self_test() -> int:
    ...
    DD = _resource("docs") / "design" / "aidoneright-claude-design"
