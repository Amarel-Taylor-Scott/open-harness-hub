...
post-session report from _repos/teleon/backend/src/teleon/observer/review.review_session (reinvention / waste / footgun findings, governed
candidate findings, serves_truth=false). No mock data — it runs the actual reviewer.

  python3 _repos/shared-backend-components/scripts/aidevobserver_demo_server.py [--port 8110]    then tunnel it
  --self-test
"""
