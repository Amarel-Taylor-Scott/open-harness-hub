...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_live_supervisor_api.py --self-test
"""
...
def _self_test() -> int:
    ...
    proj_src = (_REPO / "_repos/baltor/backend/src/baltor/workers/supervisor_projection.py").read_text()
