...
Lossless: staging is untouched. serves_truth=false; discovery≠trust.
  ...
  python3 _repos/shared-backend-components/scripts/promote_tools.py --run            # promote everything in staging that passes the gate
  python3 _repos/shared-backend-components/scripts/promote_tools.py --self-test
"""
...
PROMOTED = _resource("architecture") / "tool_registry_promoted.json"
