...
``_repos/shared-backend-components/scripts/make_review_pack.py`` lists a curated set of visual artifacts (``SCREENSHOTS``) as review
...
CLI:
    python3 _repos/shared-backend-components/scripts/check_review_pack_recorders.py             # check the real repo, print PASS/FAIL
    python3 _repos/shared-backend-components/scripts/check_review_pack_recorders.py --self-test  # fixture-logic proof + the real-repo check
"""
