...
CLI:
    python3 _repos/shared-backend-components/scripts/integrate_cfpb.py --self-test     # offline, deterministic
    python3 _repos/shared-backend-components/scripts/integrate_cfpb.py --live          # also attempt the free Federal Register fetch
"""
