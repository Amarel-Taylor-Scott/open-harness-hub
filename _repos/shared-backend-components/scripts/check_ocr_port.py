...
Proves: the port enumerates from _repos/shared-backend-components/architecture/ocr_provider_registry.json; 'auto' picks the CHEAPEST reachable engine
...
an unchanged caller uses it. serves_truth=false.
  ...
  python3 _repos/shared-backend-components/scripts/check_ocr_port.py --self-test
"""
