...
Deterministic + offline; stdlib + jsonschema + PyYAML. CLI:
    python3 _repos/shared-backend-components/scripts/render_receipt.py --self-test
"""
...
RENDER_RECEIPT_SCHEMA = _resource("schemas") / "presentation" / "render-receipt.schema.json"
