...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_cfpb_lossless_distillation.py --self-test
"""
...
RR = _load_isolated("baltor_distillation_retention_report_cfpb", "_repos/baltor/backend/src/baltor/distillation/retention_report.py")
