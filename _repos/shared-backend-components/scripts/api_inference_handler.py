...
admin server just delegates to it. It is a PROJECTION over _repos/teleon/backend/src/teleon/inference (the Inference Gateway / OIPS): the
...
#: routes this handler owns (registered in _repos/shared-backend-components/architecture/contract_registry.json#api_routes; structured-local is the
