...
Open Capability Task Specification (OCTS) — _repos/shared-backend-components/docs/standards/open-capability-task-specification.md. CTS-0 =
"platform can read + validate the task contract." This asserts:
  A. The runtime-class vocabulary (_repos/shared-backend-components/architecture/capability_runtime_classes.json) is well-formed: every class has
