...
CLI:
    python3 _repos/shared-backend-components/scripts/ci_check.py                # full gate: flywheel --once + drift-check (CI uses this)
    python3 _repos/shared-backend-components/scripts/ci_check.py --self-test    # cheap discovery check (the proof-module entrypoint)
"""
