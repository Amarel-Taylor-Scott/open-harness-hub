...
Turns the method options in `_repos/shared-backend-components/docs/concepts/retrieval-and-prompt-taxonomy.md` (R0–R6 + P1–P5)
...
(the taxonomy lists ~50 method options; this seeds the first 20 + the bundle pipeline).
    ...
    python3 _repos/shared-backend-components/scripts/seed_retrieval_taxonomy_components.py        # write the YAMLs
    python3 _repos/shared-backend-components/scripts/validate.py _repos/shared-backend-components/catalog/processors/retrieval     # gate them
...
OUT = _resource("catalog") / "processors" / "retrieval"
DATE = "2026-05-29"
