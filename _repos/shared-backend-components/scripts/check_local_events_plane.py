#!/usr/bin/env python3
"""scripts.check_local_events_plane — PROOF for _repos/shared-backend-components/scripts/events_local_service.py (the native
...
def _self_test() -> int:
    ...
    reg = json.loads((_resource("architecture") / "local_service_registry.json").read_text())
