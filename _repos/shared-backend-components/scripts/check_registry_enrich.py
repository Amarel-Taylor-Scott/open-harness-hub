"""check_registry_enrich — proof for the registry enrichment worker (_repos/teleon/backend/src/teleon/registry/enrich.py, registry #84).
...
from src.teleon.registry.enrich import py_function_src_teleon_registry_enrich__embedding, py_function_src_teleon_registry_enrich__enrich_catalog, py_function_src_teleon_registry_enrich__enrich_record  # noqa: E402
...
def main() -> int:
    ...
    e = py_function_src_teleon_registry_enrich__enrich_record(rec)["_enrichment"]
    ...
    ck("embedding is deterministic", py_function_src_teleon_registry_enrich__embedding(rec) == py_function_src_teleon_registry_enrich__embedding(rec))
    ...
    enriched = py_function_src_teleon_registry_enrich__enrich_catalog("observability")
