...
``_repos/shared-backend-components/scripts/runtime/optimization.py`` authority on the same fixture:
...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_optimization_rejection_rule_distillation.py --self-test
"""
