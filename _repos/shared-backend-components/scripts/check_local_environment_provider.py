...
_TELEON_FILES = [
    _resource("src/teleon/ports/environment_provider.py"),
    _resource("src/teleon/ports/reward_provider.py"),
    _resource("src/teleon/environments/reward_runner.py"),
    _resource("src/teleon/environments/local_environment_provider.py"),
    _resource("src/teleon/environments/baltor_cfpb_context_governance.py"),
]
