...
CLI / self-test (proves the orderings on the Acme demo tasks; no model, no network):
    python3 _repos/shared-backend-components/scripts/eval/context_lift_matrix.py --self-test
    python3 _repos/shared-backend-components/scripts/eval/context_lift_matrix.py            # print the matrix
"""
