...
(_repos/shared-backend-components/context/strategy/corpus-acquisition-grid-spec.md).
...
`expected_lift` is the capability-lift gate (_repos/shared-backend-components/scripts/eval/reason_codes.py) lifted
