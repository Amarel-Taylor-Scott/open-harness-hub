...
receipt. CLI: python3 _repos/shared-backend-components/scripts/check_verification_gate.py --self-test
"""
...
def _self_test() -> int:
    ...
    src = (_resource("scripts/runtime/verification_gate.py")).read_text()
