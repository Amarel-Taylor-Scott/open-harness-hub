...
_repos/shared-backend-components/docs/strategy/ornith-and-seha-2026-06-25.md.
...
PROTECTED = (
    ...
    "_repos/teleon/backend/src/teleon/runtime/access_policy.py",
)
...
def self_test() -> int:
    ...
    assert "scripts/run_proofs.py" in PROTECTED and "_repos/teleon/backend/src/teleon/runtime/access_policy.py" in PROTECTED
