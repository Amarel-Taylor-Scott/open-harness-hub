...
CLI:
    python3 _repos/shared-backend-components/scripts/source_expansion.py --self-test
    python3 _repos/shared-backend-components/scripts/source_expansion.py --expand "ctx://acme-billing/decisions/ADR-014-billing-retry-policy.md#decision"
"""
...
_DEMO_ROOT = _resource("demo-data")
...
def _self_test() -> int:
    ...
    try:
        ...
        schema = json.loads((_resource("schemas/context/source-expansion-response.schema.json")).read_text())
