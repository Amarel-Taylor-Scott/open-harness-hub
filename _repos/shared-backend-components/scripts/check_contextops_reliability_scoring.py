...
Deterministic, stdlib-only, offline (time injected). CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_contextops_reliability_scoring.py --self-test
"""
