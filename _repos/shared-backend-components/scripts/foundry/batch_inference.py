...
This is **lane 2** of `_repos/teleon/context/architecture/flexible-inference-lanes.md`: for long-running
...
machine can scale to zero. Full lifecycle + cost math: `_repos/teleon/context/architecture/cpu-batch-inference-lane.md`.
