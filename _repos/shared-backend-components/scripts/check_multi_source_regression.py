...
_repos/shared-backend-components/architecture/multi_source_run_matrix.json through scripts.runtime.source_consumption.run_source_to_consumption
...
CLI: python3 _repos/shared-backend-components/scripts/check_multi_source_regression.py --self-test
"""
...
_MATRIX = _resource("architecture") / "multi_source_run_matrix.json"
