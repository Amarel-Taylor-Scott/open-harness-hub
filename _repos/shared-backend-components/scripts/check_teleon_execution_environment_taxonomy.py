...
_DOC = _resource("docs") / "architecture" / "teleon-execution-environment-taxonomy.md"
_EGRESS_DOC = _resource("docs") / "architecture" / "teleon-egress-graph.md"
_PROFILE_SCHEMA = _resource("schemas") / "runtime" / "ExecutionEnvironmentProfile.schema.json"
_ROUTE_SCHEMA = _resource("schemas") / "egress" / "EgressRoutePolicy.schema.json"
