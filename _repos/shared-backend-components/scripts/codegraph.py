...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/codegraph.py --audit _repos/teleon/backend/src/teleon/synthesis/intent_to_dag.py
...
OUT_JSON = _resource("docs") / "context" / "codegraph.generated.json"
OUT_MD = _resource("docs") / "context" / "codegraph.generated.md"
...
def _self_test() -> int:
    ...
    fa = u.audit("_repos/teleon/backend/src/teleon/seeds/capability_seed.py")
