...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/build_teleon_demo_showcase.py --build
"""
...
OUT = _resource("dist") / "teleon-demos" / "showcase.html"
...
def render_html(data: dict) -> str:
    ...
    foot = ('<p class="foot">Generated by <span class="mono">scripts/build_teleon_demo_showcase.py</span> from the live '
            'capability modules <span class="mono">_repos/teleon/backend/src/teleon/extraction</span>, <span class="mono">enrichment</span>, '
