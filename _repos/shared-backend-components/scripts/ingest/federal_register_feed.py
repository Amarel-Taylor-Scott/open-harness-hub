...
CLI:
    python3 _repos/shared-backend-components/scripts/ingest/federal_register_feed.py --self-test          # offline, deterministic
    python3 _repos/shared-backend-components/scripts/ingest/federal_register_feed.py --live --demo        # real fetch + summary
"""
