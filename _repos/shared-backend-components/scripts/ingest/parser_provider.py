...
CLI:
    python3 _repos/shared-backend-components/scripts/ingest/parser_provider.py --self-test
    python3 _repos/shared-backend-components/scripts/ingest/parser_provider.py --status
"""
