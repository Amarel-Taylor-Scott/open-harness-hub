...
same `Draft202012Validator` `_repos/shared-backend-components/scripts/validate.py` uses.
...
CLI:
    python3 _repos/shared-backend-components/scripts/ingest/decompose_to_context_objects.py --self-test
"""
...
CONTEXT_OBJECT_SCHEMA = _resource("schemas") / "context-object.schema.json"
