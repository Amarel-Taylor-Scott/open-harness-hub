...
CLI:
    python3 _repos/shared-backend-components/scripts/ingest/ecfr_feed.py --self-test          # offline, deterministic
    python3 _repos/shared-backend-components/scripts/ingest/ecfr_feed.py --live               # real fetch (50 titles)
    python3 _repos/shared-backend-components/scripts/ingest/ecfr_feed.py --live --demo        # real fetch + freshness summary
"""
