...
Stdlib only. CLI:
    python3 _repos/shared-backend-components/scripts/ingest/sanctions_feed_live.py --self-test          # offline
    python3 _repos/shared-backend-components/scripts/ingest/sanctions_feed_live.py --live --limit 800   # real fetch
    python3 _repos/shared-backend-components/scripts/ingest/sanctions_feed_live.py --live --demo --limit 800
"""
