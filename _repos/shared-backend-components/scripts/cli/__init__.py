...
This package is **M5 of the north-star wave** (``_repos/_shared/codex/north-star.md`` §"The
...
Public entrypoint:
    ...
    python3 _repos/shared-backend-components/scripts/cli/oh_baltor.py --selftest
"""
