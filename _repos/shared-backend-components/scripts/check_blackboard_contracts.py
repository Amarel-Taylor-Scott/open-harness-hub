...
Asserts:
  ...
  G. REGISTERED: all 13 contracts are registered in _repos/shared-backend-components/architecture/contract_registry.json with the matching schema path.
...
_SCHEMA_DIR = _resource("schemas") / "blackboard"
