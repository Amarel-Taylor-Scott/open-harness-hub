...
Runs the unbounded->bounded descent over the real capability catalog (_repos/shared-backend-components/architecture/modality_capability_catalog.json)
...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/convert_catalog_demo.py --demo
"""
