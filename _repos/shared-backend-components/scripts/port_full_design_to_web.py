...
Source (the spec, final fidelity):   dist/sites/aidoneright-design/
Targets (the wired apps):            _repos/aidoneright/frontend/ · _repos/baltor/frontend/ · _repos/openhubforai/frontend/
...
What it does, per app:
  ...
  * HTML pages — copied with exactly three mechanical rewrites (everything else verbatim):
      ...
      3. a same-origin service-seam config script is injected so the kit's identity /
         registry / analytics clients hit this origin (_repos/shared-backend-components/scripts/showcase/server.py proxies).
...
_MARKER = (
    f"<!-- {GENERATED_MARK} from dist/sites/aidoneright-design/{{src}} — transplanted design "
...
PATCHES: dict[str, dict[str, list[tuple[str, str]]]] = {
    "teleon": {
        "teleon-main.jsx": [
            # the whole app re-renders when the REAL runtime's data lands (_repos/teleon/frontend/teleon-live.js)
            (
                "function App() {\n"
    ...
    "openhubforai": {
        ...
        "proto-catalog.jsx": [
            ...
            # hydrates the design's COMPONENTS/BY_SLUG globals (_repos/openhubforai/frontend/openhubforai-live.js).
            (
        ...
        "proto-pages-build.jsx": [
            # PPreview kicks the REAL /api/build (_repos/openhubforai/frontend/openhubforai-live.js) and re-renders
...
EXTRA_ENTRY_SCRIPTS = {"openhubforai": ["openhubforai-live.js"], "teleon": ["teleon-live.js"]}
...
APPS: dict[str, dict] = {
    ...
    "baltor": {
        ...
        "self_link_rewrites": [("Context Enrichment.html", "index.html")],
    },
    "teleon": {
        "folder": "teleon",
        "entry": "Teleon.html",
    ...
    # (_repos/shared-backend-components/scripts/teleon_local_runtime.py) really executes deterministic capabilities with receipts
    # and a real promotion gate; the site's fixtures remain the honest fallback.
    "openhubforai": {
        "folder": "openhubforai",
        "entry": "OpenHubForAI.html",
        "code": [
            ...
            "proto-landings.jsx", "proto-registry-browser.jsx", "proto-main.jsx",
            "proto.css", "proto-deep.css", "proto-byo.css", "proto-admin.css", "proto-sdg.css",
            "proto-value.css", "proto-ops.css", "proto-wide.css", "proto-registry-browser.css",
        ],
        "html": [],
    },
}
...
def generate(app: str) -> dict[str, str]:
    ...
    out[".design-port-manifest.json"] = json.dumps({
        ...
        "source": f"dist/sites/aidoneright-design/{cfg['folder']}",
        "entry": cfg["entry"],
...
def check() -> int:
    ...
    if drift:
        print("FAIL — web/ full-design files drifted from dist/sites/aidoneright-design:")
        for d in drift:
            print("  ", d)
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            for app, cfg in APPS.items():
                ...
                ck(f"{app}: service seams injected", "OPENHUBFORAI_IDENTITY_BASE" in entry and "/registry" in entry)
            ...
            ck("openhubforai: live seam patches applied",
               "OHHLive.build(task)" in (WEB / "openhubforai" / "proto-pages-build.jsx").read_text(encoding="utf-8"))
            ck("openhubforai: openhubforai-live.js wired into the entry",
               'src="openhubforai-live.js"' in (WEB / "openhubforai" / "index.html").read_text(encoding="utf-8"))
