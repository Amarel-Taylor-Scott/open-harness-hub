"""check_formula_registry — proof for _repos/shared-backend-components/architecture/formula_registry.json (backs registry #98).
...
_DOC = _resource("architecture") / "formula_registry.json"
