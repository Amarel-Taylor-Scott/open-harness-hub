#!/usr/bin/env python3
"""scripts.check_baltor_guided_demos — PROOF: the Baltor Guided Demos index (_repos/baltor/frontend/guided-demos.html, implemented
...
_PAGE = _resource("web/baltor/guided-demos.html")
_SERVER = _resource("scripts/baltor_admin_demo_server.py")
...
def _self_test() -> int:
    ...
    # G: each demo is tagged with its atlas pack's fragility modes, LOCK-STEP with _repos/shared-backend-components/architecture/fragile_context_atlas.json
