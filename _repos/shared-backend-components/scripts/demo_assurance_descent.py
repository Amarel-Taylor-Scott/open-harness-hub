...
CLI:
    python3 _repos/shared-backend-components/scripts/demo_assurance_descent.py --run [--tenant cost-first-startup]
    python3 _repos/shared-backend-components/scripts/demo_assurance_descent.py --self-test
"""
