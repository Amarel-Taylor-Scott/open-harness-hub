...
against _repos/shared-backend-components/architecture/source_authority_registry.json — never hand-typed on an artifact. Change the
...
_REGISTRY = _resource("architecture") / "source_authority_registry.json"
