...
PLANS: dict[str, dict] = {
    ...
    # capability SaaS (capability_saas_gateway) — DRAFT pricing pending owner confirmation before Stripe goes
    # live; request limits live in capability_saas_gateway.PLAN_REQUEST_LIMITS_PER_DAY (a gateway concern).
    "capability_free": {"product": "capability", "label": "Capability Free", "base_cents": 0,
                        "included_usd": 0.0, "draft_pricing": True},
    "capability_pro":  {"product": "capability", "label": "Capability Pro",  "base_cents": 2900,
                        "included_usd": 5.0, "draft_pricing": True},
}
