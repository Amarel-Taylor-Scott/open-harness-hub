...
import_module) may ONLY be imported inside an approved adapter path (_repos/baltor/backend/src/baltor/adapters, the LLM gateways).
...
CLI: python3 _repos/shared-backend-components/scripts/check_no_direct_external_imports.py --self-test
"""
...
_GOVERNED = ["_repos/baltor/backend/src/baltor", "scripts/runtime", "scripts/artifact_graph", "scripts/llm_gateway", "scripts/security", "scripts/pipeline_runtime"]
