...
CLI / self-test (offline, deterministic):
    python3 _repos/shared-backend-components/scripts/context_events.py --self-test
"""
...
EVENT_KINDS: frozenset[str] = frozenset({
    ...
    # Context Auditor (_repos/baltor/backend/src/baltor/context_audit) — pre-LLM-call audit-manifest signals (Optimization stage);
