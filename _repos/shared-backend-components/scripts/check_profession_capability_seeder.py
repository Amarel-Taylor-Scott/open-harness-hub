...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_profession_capability_seeder.py --build | --self-test
"""
...
_FEED = _resource("data") / "capability-candidates" / "discovered-feed-profession-scale-2026-06-20.json"
