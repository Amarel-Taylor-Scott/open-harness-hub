...
license. serves_truth=false.
  ...
  python3 _repos/shared-backend-components/scripts/check_web_browsing_stack_registry.py --self-test
"""
...
def _self_test() -> int:
    ...
    rcat = json.loads((_resource("architecture") / "research_component_catalog.json").read_text(encoding="utf-8"))["components"]
