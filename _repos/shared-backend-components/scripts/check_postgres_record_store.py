...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_postgres_record_store.py --self-test
"""
...
#    offline, exactly as _repos/teleon/backend/src/teleon/storage/git_record_store.py does for its pgvector mirror). ──────────
class _RecordCursor:
