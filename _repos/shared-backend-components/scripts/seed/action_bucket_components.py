...
standardized builder (scripts.seed.component_seed) so attribution is consistent.
    ...
    python3 _repos/shared-backend-components/scripts/validate.py _repos/shared-backend-components/catalog/processors/deliver/*.yaml _repos/shared-backend-components/catalog/processors/platform/*.yaml
"""
