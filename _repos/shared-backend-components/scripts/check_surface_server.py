...
Asserts the linchpin guarantees of _repos/shared-backend-components/scripts/surface_server.py without opening a real socket (drives the route
...
Prints PASS/FAIL with a computed assertion count; exits nonzero on failure. serves_truth=false.
  ...
  python3 _repos/shared-backend-components/scripts/check_surface_server.py --self-test
"""
...
from src.teleon.registry.browse import py_const_src_teleon_registry_browse__FACET_DIMS, py_function_src_teleon_registry_browse__browse  # noqa: E402
...
def _checks() -> int:
    ...
    live = py_function_src_teleon_registry_browse__browse("", {})
