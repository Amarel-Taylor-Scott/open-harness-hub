...
CLI:
    python3 _repos/shared-backend-components/scripts/check_live_pipeline.py --self-test
"""
...
def _self_test() -> int:
    ...
    env = {**os.environ, "PYTHONPATH": _pythonpath(".")}  # so the server can import scripts.*
