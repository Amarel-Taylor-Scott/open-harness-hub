...
under _repos/baltor/backend/src/baltor/ports with exactly the required method surface, are runtime_checkable, and live in the ports
...
CLI: python3 _repos/shared-backend-components/scripts/check_ingestion_ports.py --self-test
"""
