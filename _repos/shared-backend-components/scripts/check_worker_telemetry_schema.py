...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_worker_telemetry_schema.py --self-test
"""
...
_SCHEMA = _resource("schemas/workers/WorkerTelemetry.schema.json")
