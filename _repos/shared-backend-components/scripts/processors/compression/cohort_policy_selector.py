...
The prediction-error-gated thesis (`_repos/shared-backend-components/context/concepts/prediction-error-gated-context.md`, Axis 3):
...
CLI / self-test:
    python3 _repos/shared-backend-components/scripts/processors/compression/cohort_policy_selector.py
