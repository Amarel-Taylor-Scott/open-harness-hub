...
`_repos/shared-backend-components/catalog/processors/compression/` manifests — the *Compressed* tier of the
Baltor service (see `_repos/baltor/context/strategy/context-enrichment-service.md`).
...
Modules:
  ...
  usage_gated_compress — backs processor/usage-gated-compress
                         ...
                         _repos/shared-backend-components/context/concepts/prediction-error-gated-context.md.
"""
