...
``_repos/baltor/context/strategy/context-enrichment-service.md``.
...
CLI / self-test:
    python3 _repos/shared-backend-components/scripts/processors/compression/structural_compress.py
