...
This package holds the implementations behind the `_repos/shared-backend-components/catalog/processors/retrieval/`
manifests — the swappable method-components of the governed retrieval pipeline
(see `_repos/shared-backend-components/docs/concepts/retrieval-and-prompt-taxonomy.md`). Each manifest's
