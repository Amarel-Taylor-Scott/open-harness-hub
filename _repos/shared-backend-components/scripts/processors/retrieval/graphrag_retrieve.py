...
(intaken as a tool candidate — see _repos/shared-backend-components/context/research/github-repo-intel-2026-06-12.md).
...
CLI / self-test: python3 _repos/shared-backend-components/scripts/processors/retrieval/graphrag_retrieve.py
"""
