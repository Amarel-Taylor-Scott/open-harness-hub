...
so the nine action modules stay thin and cannot drift (_repos/shared-backend-components/docs/codex/no-magic-values.md).
"""
...
# payloads cannot collapse onto the same id (_repos/shared-backend-components/docs/codex ID/hash discipline).
ID_SUFFIX_LEN = 16
