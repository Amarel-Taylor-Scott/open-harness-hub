...
self-graded** (see ``_repos/baltor/context/strategy/context-enrichment-service.md`` §"Measured
...
CLI / self-test:
    python3 _repos/shared-backend-components/scripts/processors/verify/compression_fidelity_check.py
