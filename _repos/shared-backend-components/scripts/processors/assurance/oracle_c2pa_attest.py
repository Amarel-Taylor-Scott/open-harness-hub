...
``_repos/shared-backend-components/catalog/processors/assurance/oracle-c2pa-attest.yaml`` — process_kind
...
``_repos/shared-backend-components/docs/codex/no-magic-values.md``); it declares the runtime contract programmatically in
...
``_repos/shared-backend-components/context/architecture/component-execution-and-runtime-routing.md`` §4).
...
CLI / self-test:
    python3 _repos/shared-backend-components/scripts/processors/assurance/oracle_c2pa_attest.py
            ...
            "assertions": [
                ...
                },
                {
                    ...
                    "data": {"actions": [{
                        ...
                        "softwareAgent": "openhubforai/oracle-c2pa-attest",
                        "when": as_of,
                    }]},
                },
                {
