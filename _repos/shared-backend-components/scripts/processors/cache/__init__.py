...
`_repos/shared-backend-components/catalog/processors/cache/` manifests — the cache lane of the context layer
(see `_repos/_shared/strategy/context-layer-pmf.md`).
