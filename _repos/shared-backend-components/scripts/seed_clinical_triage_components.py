...
Same iteration pattern as _repos/shared-backend-components/scripts/seed_retrieval_taxonomy_components.py — extend COMPONENTS to add
more. Run: python3 _repos/shared-backend-components/scripts/seed_clinical_triage_components.py && python3 _repos/shared-backend-components/scripts/validate.py _repos/shared-backend-components/catalog/processors/clinical/*.yaml
"""
...
OUT = _resource("catalog") / "processors" / "clinical"
DATE = "2026-05-29"
