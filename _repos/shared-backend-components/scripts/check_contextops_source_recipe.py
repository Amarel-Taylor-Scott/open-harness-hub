...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_contextops_source_recipe.py --self-test
"""
...
_SCHEMA = _resource("schemas") / "contextops" / "SourceRecipe.schema.json"
