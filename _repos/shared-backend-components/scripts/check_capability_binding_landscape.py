...
platform-capability-API / serverless-runtime LANDSCAPE (_repos/shared-backend-components/architecture/capability_binding_landscape.json).
...
_CATALOG = _resource("architecture") / "capability_binding_landscape.json"
