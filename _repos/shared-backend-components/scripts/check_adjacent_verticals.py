...
pipeline), so a future insurance vertical/demo fails the gate instead of slipping in. serves_truth=false.
  ...
  python3 _repos/shared-backend-components/scripts/check_adjacent_verticals.py --self-test
"""
...
V = _resource("architecture") / "adjacent_verticals.json"
LOOPS = _resource("architecture") / "agentic_loop_catalog.json"
