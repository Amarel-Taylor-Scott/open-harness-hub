...
estimate far below a naive always-LLM+review-everything baseline. serves_truth=false.
  ...
  python3 _repos/shared-backend-components/scripts/check_provider_directory.py --self-test
  python3 _repos/shared-backend-components/scripts/check_provider_directory.py --demo        # prints the HealthLynked example recommendations
"""
