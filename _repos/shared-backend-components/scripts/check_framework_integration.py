...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_framework_integration.py --self-test
"""
...
_MATRIX = _resource("architecture") / "framework_integration_matrix.json"
