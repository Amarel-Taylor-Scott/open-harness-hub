...
NAMESPACE = "openhubforai"


def dataset_facets(manifest: dict) -> dict:
    return {
        "schema": {
            "_producer":     "https://openhubforai.io",
        ...
        "dataSource": {
            ...
            "name":        NAMESPACE,
            "uri":         f"https://openhubforai.io/{manifest['type']}/{slug_only(manifest['id'])}",
        },
    }
...
def render(pipeline: dict, catalog: dict) -> dict:
    ...
    event = {
        ...
        "producer":   "https://openhubforai.io/emitter/openlineage@0.1.0",
