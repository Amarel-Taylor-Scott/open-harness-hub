...
Output: dist/spdx/openhubforai.spdx.json
"""
...
def spdx_element(manifest: dict) -> dict:
    ...
    return {
        ...
        "homepage":   f"https://openhubforai.io/{manifest['type']}/{slug_only(manifest['id'])}",
...
def main() -> int:
    ...
    creation_info = {
        ...
        "createdUsing": [f"{NS}tool/openhubforai-emitter"],
        "created":     now,
    ...
    out = DIST / "spdx" / "openhubforai.spdx.json"
