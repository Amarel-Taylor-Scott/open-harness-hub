...
Composition (real `_repos/shared-backend-components/scripts/processors` callables + deterministic temporal ownership resolution):
...
Run:  python3 _repos/shared-backend-components/scripts/showcase_pipelines/common_control_resolver.py [--self-test]
"""
