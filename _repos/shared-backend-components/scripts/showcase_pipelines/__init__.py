...
Each module here chains the actual `_repos/shared-backend-components/scripts/processors/**/run()` callables end-to-end
...
`_repos/shared-backend-components/scripts/flywheel_proof_modules.py` as `showcase_*`) — a processor change that breaks a
