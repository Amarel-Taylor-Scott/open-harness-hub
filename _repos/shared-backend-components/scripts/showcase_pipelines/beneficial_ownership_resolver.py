...
Composition (the REAL source-authority classifier + real `_repos/shared-backend-components/scripts/processors` callables + deterministic
...
Run:  python3 _repos/shared-backend-components/scripts/showcase_pipelines/beneficial_ownership_resolver.py [--self-test]
"""
