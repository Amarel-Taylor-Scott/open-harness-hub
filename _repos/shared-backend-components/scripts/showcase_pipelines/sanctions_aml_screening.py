...
Composition (real `_repos/shared-backend-components/scripts/processors` callables):
...
Run:  python3 _repos/shared-backend-components/scripts/showcase_pipelines/sanctions_aml_screening.py [--self-test]
"""
