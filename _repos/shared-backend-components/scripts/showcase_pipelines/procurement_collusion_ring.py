...
Composition (real `_repos/shared-backend-components/scripts/processors` callables + deterministic bid-pattern aggregation):
...
Run:  python3 _repos/shared-backend-components/scripts/showcase_pipelines/procurement_collusion_ring.py [--self-test]
"""
