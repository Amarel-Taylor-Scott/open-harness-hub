...
Composition (every step a real `_repos/shared-backend-components/scripts/processors` callable):
...
Run:  python3 _repos/shared-backend-components/scripts/showcase_pipelines/low_resource_alert.py [--self-test]
"""
