...
from src.baltor.workers.execution_backend_selector import py_const_src_teleon_runtime_execution_backend_selector__GENERIC_FUNCTIONS
...
def _self_test() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        check("C: a generic cloud function is NEVER chosen on the live path (hard guard holds)",
              c["backend"] not in py_const_src_teleon_runtime_execution_backend_selector__GENERIC_FUNCTIONS, str(c["backend"]))
