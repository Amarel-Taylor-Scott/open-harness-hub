...
Asserts:
  A. FILE LOADS: _repos/shared-backend-components/architecture/lowcost_llm_endpoint_registry.json parses; has version/note/governance_law/
...
_REGISTRY = _resource("architecture") / "lowcost_llm_endpoint_registry.json"
