"""check_vertical_playbooks — proof for _repos/shared-backend-components/architecture/vertical_playbooks.json (backs registry #93).
...
_DOC = _resource("architecture") / "vertical_playbooks.json"
