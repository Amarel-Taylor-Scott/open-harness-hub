...
CLI: python3 _repos/shared-backend-components/scripts/check_standards_ui.py --self-test
"""
...
_PAGE = _resource("web/baltor/standards.html")
...
def _self_test() -> int:
    ...
    check("_repos/baltor/frontend/standards.html exists", _PAGE.exists())
