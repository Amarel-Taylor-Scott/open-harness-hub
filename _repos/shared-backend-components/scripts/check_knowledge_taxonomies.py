"""check_knowledge_taxonomies — proof for _repos/shared-backend-components/architecture/knowledge_taxonomies.json (backs registry #81).
...
_DOC = _resource("architecture") / "knowledge_taxonomies.json"
