...
def _self_test() -> int:
    ...
    generic = sel.py_function_src_teleon_runtime_execution_backend_selector__generic_functions(_MATRIX)
    ...
    actions = {sel.py_function_src_teleon_runtime_execution_backend_selector___action_for(b) for b in generic}
    ...
    check("D: adding a peer in CONFIG extends the guard with no code change", "newcloud_fn@candidate" in sel.py_function_src_teleon_runtime_execution_backend_selector__generic_functions(synth))
    ...
    d_no_creds = sel.py_function_src_teleon_runtime_execution_backend_selector__select_backend(task, policy_matrix=_MATRIX)
    ...
    d_no_aws = sel.py_function_src_teleon_runtime_execution_backend_selector__select_backend(task, policy_matrix=_MATRIX, available_creds={"gcp_cloud_function@candidate"},
