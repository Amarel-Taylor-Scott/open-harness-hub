...
YAML files in _repos/shared-backend-components/catalog/ are git-tracked, PR-reviewable, forkable,
...
Usage:
    python3 _repos/shared-backend-components/scripts/build_catalog_db.py
    python3 _repos/shared-backend-components/scripts/build_catalog_db.py --row-dir dist/catalog-db-export-rows
    OH_BUILD_EMBEDDINGS=1 python3 _repos/shared-backend-components/scripts/build_catalog_db.py   # with vectors
"""
