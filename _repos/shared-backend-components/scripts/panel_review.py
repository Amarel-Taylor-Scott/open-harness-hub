...
(_repos/shared-backend-components/architecture/storage_tier_policy.json) so the board's judgments accumulate over time.
...
CLI: python3 _repos/shared-backend-components/scripts/panel_review.py --run --round all
"""
...
PANEL_DIR = _resource("docs") / "reviews" / "panel"
