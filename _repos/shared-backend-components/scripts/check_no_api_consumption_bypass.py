...
CLI: python3 _repos/shared-backend-components/scripts/check_no_api_consumption_bypass.py --self-test
"""
...
def _self_test() -> int:
    ...
    handler = (_resource("scripts/api_context_handler.py")).read_text(encoding="utf-8")
