...
DEFAULT_SOURCE = _resource("docs") / "strategy" / "baltor-adjacent-market-map.md"
DEFAULT_OUT = _resource("dist") / "market-map-context-bridge"
TENANT_ID = "baltor"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.self_test:
        return self_test()
    source = args.source if args.source.is_absolute() else _resource(args.source)
