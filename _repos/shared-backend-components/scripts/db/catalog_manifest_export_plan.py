...
The input row-set directory can be produced by:
    ...
    python3 _repos/shared-backend-components/scripts/db/catalog_manifest_bridge.py --output-dir dist/catalog-manifest-bridge
...
DEFAULT_ROW_DIR = _resource("dist") / "catalog-manifest-bridge"
DEFAULT_OUT = _resource("dist") / "catalog-manifest-export"
COMPONENT_DIRS = {
    "harness": "harnesses",
    "pipeline": "pipelines",
