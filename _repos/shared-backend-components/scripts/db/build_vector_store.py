...
Embedder selection is pluggable and offline-first:
  ...
  * the registered hash fallback deterministic feature-hashing bag-of-words ->
    ...
    (_repos/shared-backend-components/docs/codex/billion-component-goal.md). Good enough to prove the plumbing
...
# Embedding backend selection is centralized in _repos/shared-backend-components/scripts/embeddings.py and is
