...
DEFAULT_PARITY_REPORT = _resource("dist") / "catalog-migration-smoke" / "catalog-row-roundtrip-parity.json"
DEFAULT_OUTPUT = _resource("dist") / "catalog-migration-smoke" / "catalog-db-export-staleness-gate.json"
