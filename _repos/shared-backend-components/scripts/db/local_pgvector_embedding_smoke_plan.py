...
def _self_test() -> int:
    ...
    embedding_plan = _resource("dist/daily-embedding-execution/2026-05-31/embedding-plan/embedding-execution-plan.json")
    readiness = _resource("dist/local-hash-embedding-worker/2026-05-31/vector-readiness/vector-readiness-summary.json")
