...
Drives _repos/shared-backend-components/scripts/generate_from_template.py in a deterministic temp repo (templates/ + catalog copied in, no
...
CLI: python3 _repos/shared-backend-components/scripts/check_template_generation.py --self-test
"""
