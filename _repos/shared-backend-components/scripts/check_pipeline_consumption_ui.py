#!/usr/bin/env python3
"""scripts.check_pipeline_consumption_ui — proof (D-PIPE-CON-1): _repos/baltor/frontend/pipeline/consumption.html is a
...
Static source scan — deterministic, offline. CLI: python3 _repos/shared-backend-components/scripts/check_pipeline_consumption_ui.py --self-test
"""
...
_PAGE = _resource("web/baltor/pipeline/consumption.html")
...
def _self_test() -> int:
    ...
    check("_repos/baltor/frontend/pipeline/consumption.html exists", _PAGE.exists())
    if not _PAGE.exists():
