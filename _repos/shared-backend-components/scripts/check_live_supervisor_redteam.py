...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_live_supervisor_redteam.py --self-test
"""
...
def _self_test() -> int:
    ...
    sup_sources = [
        _REPO / "_repos/baltor/backend/src/baltor/workers/supervisor_store.py",
        _REPO / "_repos/baltor/backend/src/baltor/workers/supervisor_watch.py",
        _resource("scripts/check_live_supervisor_two_process.py"),
    ]
    ...
    cp = (_REPO / "_repos/baltor/backend/src/baltor/workers/supervisor_store.py").read_text() + (_REPO / "_repos/baltor/backend/src/baltor/workers/supervisor_watch.py").read_text()
