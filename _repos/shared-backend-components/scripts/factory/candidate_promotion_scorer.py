...
DEFAULT_WEIGHTS = {
    ...
    # High = defensible. Single source: _repos/shared-backend-components/scripts/eval/reason_codes.py — see
    # _repos/shared-backend-components/docs/concepts/capability-valleys.md.
    "durability": 1.0,
}
