#!/usr/bin/env python3
"""scripts.check_teleon_client — PROOF for _repos/baltor/backend/src/baltor/teleon_client (Baltor→Teleon migration step 4, FINAL).
...
_CLIENT_SRC = _resource("src/baltor/teleon_client/client.py")
