...
where generation is needed (meta descriptions, use-cases, alternatives). For every record it runs a CHECKLIST:
  * DETERMINISTIC (always, reuses _repos/teleon/backend/src/teleon/registry/enrich.py): keywords · labels · meta_description · use_cases.
...
STATE = _resource("data") / "dev-intel" / "enrich_cursor.json"
