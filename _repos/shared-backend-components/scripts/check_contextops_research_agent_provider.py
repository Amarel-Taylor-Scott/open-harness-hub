...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_contextops_research_agent_provider.py --self-test
"""
...
_SCHEMA = _resource("schemas") / "contextops" / "SourceDiscoveryReport.schema.json"
