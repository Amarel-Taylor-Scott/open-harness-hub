...
from src.teleon.agents.agent_runtime_provider import (  # noqa: E402
    py_const_src_teleon_agents_agent_runtime_provider__AGENT_SERVES_TRUTH, py_const_src_teleon_agents_agent_runtime_provider__DEFAULT_AGENT_BUCKET, py_const_src_teleon_agents_agent_runtime_provider__LOCAL_EMULATOR_RUNTIME_ID, py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeProviderPort,
    py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeRequest, py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeResult, py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeUnavailable, py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeUnavailableResult,
    py_class_src_teleon_agents_agent_runtime_provider__CandidateAgentRuntime, py_class_src_teleon_agents_agent_runtime_provider__LocalEmulatorAgentRuntime, py_function_src_teleon_agents_agent_runtime_provider__dispatch_agent_request, py_function_src_teleon_agents_agent_runtime_provider__get_runtime, py_function_src_teleon_agents_agent_runtime_provider__load_catalog,
)
...
def main() -> int:
    ...
    if not (len(active) == 1 and active[0]["runtime_id"] == py_const_src_teleon_agents_agent_runtime_provider__LOCAL_EMULATOR_RUNTIME_ID):
    ...
    emu = py_class_src_teleon_agents_agent_runtime_provider__LocalEmulatorAgentRuntime()
    if not isinstance(emu, py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeProviderPort):
    ...
    req = py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeRequest(task_id="T1", tenant_id="acme", runtime_id=py_const_src_teleon_agents_agent_runtime_provider__LOCAL_EMULATOR_RUNTIME_ID,
    ...
    if not (isinstance(r1, py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeResult) and r1.status == "succeeded"):
        fails.append("local emulator must succeed offline")
    if r1.serves_truth is not False or py_const_src_teleon_agents_agent_runtime_provider__AGENT_SERVES_TRUTH is not False:
    ...
    for rid in ("clawless_openclaw@candidate", "hermes@candidate"):
        prov = py_function_src_teleon_agents_agent_runtime_provider__get_runtime(rid, catalog=cat)
        if not isinstance(prov, py_class_src_teleon_agents_agent_runtime_provider__CandidateAgentRuntime):
        ...
        if not _raises(py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeUnavailable, prov.run_agent, req, backend="k8s_job@candidate", now=NOW):
    ...
    env = py_function_src_teleon_agents_agent_runtime_provider__dispatch_agent_request(
        py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeRequest(task_id="T2", tenant_id="acme", runtime_id=py_const_src_teleon_agents_agent_runtime_provider__LOCAL_EMULATOR_RUNTIME_ID, intent="triage"),
        now=NOW)
    if env["runtime_status"] != "active" or not isinstance(env["result"], py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeResult):
    ...
    open_req = py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeRequest(task_id="T3", tenant_id="acme", runtime_id="hermes@candidate",
                                   intent="browse + act", worker_bucket=py_const_src_teleon_agents_agent_runtime_provider__DEFAULT_AGENT_BUCKET)
    env_open = py_function_src_teleon_agents_agent_runtime_provider__dispatch_agent_request(open_req, now=NOW)
    ...
    if not isinstance(env_open["result"], py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeUnavailableResult):
    ...
    env_k8s = py_function_src_teleon_agents_agent_runtime_provider__dispatch_agent_request(
        open_req, now=NOW,
    ...
    env_unknown = py_function_src_teleon_agents_agent_runtime_provider__dispatch_agent_request(
        py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeRequest(task_id="T4", tenant_id="acme", runtime_id="nope@x", intent="x"), now=NOW)
    if not (env_unknown["runtime_status"] == "unknown"
            and isinstance(env_unknown["result"], py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeUnavailableResult)):
    ...
    src = (_resource("src/teleon/agents/agent_runtime_provider.py")).read_text()
