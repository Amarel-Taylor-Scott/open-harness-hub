...
service registry (_repos/shared-backend-components/architecture/local_service_registry.json — single source; drift-gated by the proof).
"""
...
class EventsPlane:
    def __init__(self, state_dir: Path | None = None, clock: Callable[[], float] | None = None,
        ...
        self.state_dir = Path(state_dir) if state_dir else (_resource("dist") / "analytics")
