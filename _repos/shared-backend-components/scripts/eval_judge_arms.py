...
Usage:
  python3 _repos/shared-backend-components/scripts/eval_judge_arms.py
  python3 _repos/shared-backend-components/scripts/eval_judge_arms.py --vertical esg
  python3 _repos/shared-backend-components/scripts/eval_judge_arms.py --max-samples 1
