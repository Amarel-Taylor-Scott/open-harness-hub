...
The lossless law (``_repos/shared-backend-components/docs/codex/lossless-distillation.md``) is only worth anything if it cannot be DEFEATED.
...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_lossless_distillation_redteam.py --self-test
"""
