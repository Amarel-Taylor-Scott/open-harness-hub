#!/usr/bin/env python3
"""config_ui_server — serve the medium-config UI + SAVE the client's selections to _repos/shared-backend-components/architecture/medium_config.json.
...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/config_ui_server.py --serve
"""
...
_CONFIG = _resource("architecture") / "medium_config.json"
