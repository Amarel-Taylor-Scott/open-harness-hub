...
CLI:
    python3 _repos/shared-backend-components/scripts/context_debt.py --self-test
"""
...
DEBT_SCHEMA = _resource("schemas") / "context-debt-item.schema.json"
...
def _self_test() -> int:
    ...
    v = _validator()
    fixture = json.loads((_resource("fixtures/context-debt-item.example.json")).read_text(encoding="utf-8"))
