...
(_repos/shared-backend-components/architecture/portfolio_connection_map.json), the strategy (_repos/shared-backend-components/architecture/hub_population_strategy.json) must declare a
...
file's own legends (no-magic-values). Run before trusting hub coverage.
  ...
  python3 _repos/shared-backend-components/scripts/check_hub_population_coverage.py            # check the repo
  python3 _repos/shared-backend-components/scripts/check_hub_population_coverage.py --self-test
"""
