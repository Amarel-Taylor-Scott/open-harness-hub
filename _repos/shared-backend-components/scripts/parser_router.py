...
port (scripts/parser_provider.py) and benchmarked via OmniDocBench (_repos/shared-backend-components/docs/evals/parser-benchmark.md);
...
CLI:
    python3 _repos/shared-backend-components/scripts/parser_router.py --self-test
    python3 _repos/shared-backend-components/scripts/parser_router.py --scanned --table-density high
"""
