...
(_repos/shared-backend-components/architecture/native_output_modes.json) is the canonical, well-formed single source for the 8 output_modes.
...
Deterministic + offline: reads only the committed registry file. CLI: python3 _repos/shared-backend-components/scripts/check_native_output_modes.py --self-test
"""
...
_MODES_FILE = _resource("architecture") / "native_output_modes.json"
