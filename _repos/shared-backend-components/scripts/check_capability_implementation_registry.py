...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_capability_implementation_registry.py --self-test
"""
...
_FEED = _resource("data") / "capability-candidates" / "discovered-feed-workspace-inventory-2026-06-20.json"
