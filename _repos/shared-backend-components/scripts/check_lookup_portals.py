"""check_lookup_portals — proof for _repos/shared-backend-components/architecture/lookup_portals.json (backs registry #72 lookup_portals).
...
_DOC = _resource("architecture") / "lookup_portals.json"
