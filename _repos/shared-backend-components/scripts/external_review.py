...
GOVERNANCE (mirrors _repos/shared-backend-components/architecture/lowcost_llm_endpoint_registry.json): external lanes, allowed_data_classes=
...
.env and never logged.
  ...
  --live                actually call the models (network egress) -> _repos/shared-backend-components/docs/reviews/external-review/
  --provider ollama|openrouter   pick the lane (default: ollama)
  --models a,b          override model ids
CLI: python3 _repos/shared-backend-components/scripts/external_review.py --live
"""
...
OUT_DIR = _resource("docs") / "reviews"
...
PROVIDERS = {
    ...
    "openrouter": {"base_url": "https://openrouter.ai/api/v1", "key_var": "OPENROUTER_API_KEY",
                   ...
                   "headers": {"HTTP-Referer": "https://aidoneright.dev", "X-Title": "OpenHubForAI external review"}},
}
...
PACK_SOURCES = [
    ("CLAUDE.md", 9000),
    ("docs/strategy/teleon-baltor-openhubforai-portfolio.md", 4000),
    ...
    ("_repos/teleon/backend/src/teleon/evolution/descent_axes.py", 4500),
    ("_repos/teleon/backend/src/teleon/evolution/descent_attempt_store.py", 2500),
    ("_repos/teleon/backend/src/teleon/evolution/substrate_selector.py", 2500),
    ("_repos/teleon/backend/src/teleon/storage/record_store.py", 2500),
    ("_repos/teleon/backend/src/teleon/objectives/objective.py", 2500),
    ("_repos/teleon/backend/src/teleon/inference/model_index.py", 2000),
]
