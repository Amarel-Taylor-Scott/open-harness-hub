...
(_repos/shared-backend-components/scripts/portfolio_lib.py) into dist/portfolio-public/<site>/index.html. Local CSS only; no external CDN/JS/secrets.
...
_WEB = _resource("websites")
_BUILD_MANIFEST = _resource("dist/portfolio-sites-build.json")
...
""", encoding="utf-8")
    ...
    # standards-interoperability page, generated from _repos/shared-backend-components/architecture/standards_interop_manifest.json (its own
