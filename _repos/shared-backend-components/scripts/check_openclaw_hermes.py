...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_openclaw_hermes.py --self-test
"""
...
def _self_test() -> int:
    ...
    import json
    strat = json.loads((_resource("architecture") / "hub_population_strategy.json").read_text(encoding="utf-8"))["hubs"]
