...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_local_execution_providers.py --self-test
"""
...
from src.baltor.workers.execution_providers.container_image_emulator import py_class_src_teleon_runtime_execution_providers_container_image_emulator__ContainerImageEmulator
...
from src.baltor.workers.execution_providers.managed_venv import py_class_src_teleon_runtime_execution_providers_managed_venv__ManagedVenvProvider
...
def _self_test() -> int:
    ...
    mv = py_class_src_teleon_runtime_execution_providers_managed_venv__ManagedVenvProvider()
    ...
    mv_src = (_REPO / "_repos/teleon/backend/src/teleon/runtime/execution_providers/managed_venv.py").read_text()  # canonical Teleon home (Baltor re-exports)
    ...
    ci = py_class_src_teleon_runtime_execution_providers_container_image_emulator__ContainerImageEmulator(docker_available=False).run(image="py:demo", command=[sys.executable, "-c", "print(1)"], task_id="c1")
