...
seam; escalate-before-concluding-unavailable). See _repos/shared-backend-components/docs/security/mcp-and-skill-security.md.

CLI:
    python3 _repos/shared-backend-components/scripts/security/skill_scanner.py path/to/SKILL.md           # scan one artifact
    python3 _repos/shared-backend-components/scripts/security/skill_scanner.py path/to/dir --json         # scan a tree, JSON out
    python3 _repos/shared-backend-components/scripts/security/skill_scanner.py --self-test                # the offline proof
"""
