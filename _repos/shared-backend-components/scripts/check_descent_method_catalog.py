...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_descent_method_catalog.py --build | --self-test
"""
...
_CAT = _resource("architecture") / "descent_method_catalog.json"
_MAP = _resource("docs") / "architecture" / "descent-method-catalog.md"
