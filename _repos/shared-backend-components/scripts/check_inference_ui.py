...
The inference plane has a read-only page (_repos/baltor/frontend/inference-plane.html) served at /inference-plane, and the Live
...
Asserts:
  A. PAGE EXISTS + REACHABLE: _repos/baltor/frontend/inference-plane.html exists and the admin server serves /inference-plane
