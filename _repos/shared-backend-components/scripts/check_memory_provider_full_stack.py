...
CLI: python3 _repos/shared-backend-components/scripts/check_memory_provider_full_stack.py --self-test
"""
...
_TRACE_SCHEMA = _resource("schemas") / "memory" / "MemoryTrace.schema.json"
