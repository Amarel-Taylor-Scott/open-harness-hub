"""check_geospatial_sources — proof for _repos/shared-backend-components/architecture/geospatial_sources.json (backs registry #77).
...
_DOC = _resource("architecture") / "geospatial_sources.json"
