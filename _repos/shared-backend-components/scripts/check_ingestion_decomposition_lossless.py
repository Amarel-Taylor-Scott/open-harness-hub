...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_ingestion_decomposition_lossless.py --self-test
"""
...
RR = _load_isolated("baltor_distillation_retention_report_ingest", "_repos/baltor/backend/src/baltor/distillation/retention_report.py")
