...
(_repos/baltor/backend/src/baltor/experiments/). It RUNS and ASSERTS every layer of the engine end to end and prints the
...
CLI: PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_parallel_path_full_stack.py --self-test
"""
