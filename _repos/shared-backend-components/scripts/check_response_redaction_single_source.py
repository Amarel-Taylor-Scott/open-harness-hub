...
allow-list is SINGLE-SOURCED in _repos/shared-backend-components/scripts/security/response_redaction.py, never re-declared per handler.
...
_HANDLERS = sorted((_resource("scripts")).glob("api_*_handler.py"))
