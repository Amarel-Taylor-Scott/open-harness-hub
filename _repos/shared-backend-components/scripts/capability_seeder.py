...
The side runner (_repos/shared-backend-components/scripts/context_workers/capability_discovery_runner.py) finds candidates from public sources
...
CLI:
    python3 _repos/shared-backend-components/scripts/capability_seeder.py --self-test
    python3 _repos/shared-backend-components/scripts/capability_seeder.py --feed data/capability-candidates/discovered-feed-2026-06-19.json --summary
    python3 _repos/shared-backend-components/scripts/capability_seeder.py --feed <path> --stage      # write staged-candidates.jsonl
"""
...
_STAGING_DIR = _resource("data") / "capability-candidates"
