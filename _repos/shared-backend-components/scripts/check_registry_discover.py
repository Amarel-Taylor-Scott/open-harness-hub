"""check_registry_discover — proof for catalog auto-discovery (_repos/teleon/backend/src/teleon/registry/port.py).

Auto-discovery scans _repos/shared-backend-components/architecture/*.json and registers every VALIDATED catalog-shaped registry so federated search
