...
CLI:
    python3 _repos/shared-backend-components/scripts/context_workers/distillation_runner.py --self-test
    python3 _repos/shared-backend-components/scripts/context_workers/distillation_runner.py --once --min-ceiling 0.99
    python3 _repos/shared-backend-components/scripts/context_workers/distillation_runner.py --loop --interval 3600   # owner-launched
"""
