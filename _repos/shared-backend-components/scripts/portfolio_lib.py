...
Boundary copy is consistent with _repos/shared-backend-components/docs/strategy/teleon-baltor-openhubforai-portfolio.md (the portfolio thesis).
...
DIST = _resource("dist") / "portfolio-public"
...
def _fragile_atlas_section() -> tuple[str, str]:
    ...
    page can never drift from _repos/shared-backend-components/architecture/fragile_context_atlas.json. Names system TYPES only — never a vendor."""
    tax = json.loads((_resource("architecture") / "fragile_context_taxonomy.json").read_text(encoding="utf-8"))
    atlas = json.loads((_resource("architecture") / "fragile_context_atlas.json").read_text(encoding="utf-8"))
...
HUB_PORT = 9100
PORTS = {"aidoneright": 9101, "teleon.dev": 9102, "baltor": 9103, "openhubforai": 9104,
...
SIGNATURE = {
    ...
    "openhubforai": ["open harnesses", "rubrics", "conformance packs"],
}
...
SITES: dict[str, dict] = {
    "aidoneright": {
        ...
        "use_case": "Understand how Teleon, Baltor, and OpenHubForAI fit together and who owns what.",
        ...
        "diagram": "OpenHubForAI → Teleon → Baltor   ·   AI Done Right coordinates portfolio · IP · research · specs",
        "relationship": "OpenHubForAI supplies reusable capability parts. Teleon runs and evolves capabilities. "
        ...
        "sections": [
            ...
            ("Portfolio companies", "Teleon (the runtime that makes capabilities efficient), Baltor (the engine that "
             "makes them trustworthy), and OpenHubForAI (the open component registries)."),
        ],
        ...
        "required_phrases": ["The right model, method, and cost for every AI task — and easy to build.", "Teleon", "Baltor",
                             "OpenHubForAI", "portfolio", "OpenHubForAI → Teleon → Baltor", "does not own"],
    ...
    "teleon.dev": {
        ...
        "not_owns": ["Governed context truth (that is Baltor)", "The open skill registry (that is OpenHubForAI)"],
        ...
        "relationship": "Teleon runs and evolves capabilities. Baltor consumes Teleon through the "
                        ...
                        "Teleon consumes templates, skills, and eval packs from OpenHubForAI.",
        "sections": [
    ...
    "baltor": {
        ...
        "what_it_is_not": ["Not a generic compute runtime (that is Teleon).",
                           "Not a generic cloud-task orchestrator.", "Not an open skill registry (that is OpenHubForAI)."],
        ...
        "relationship": "Baltor governs the context capabilities produce. Baltor uses Teleon through the "
                        ...
                        "Baltor uses governance/verification harnesses from OpenHubForAI.",
        "sections": [
    ...
    "openskillshub": {
        ...
        "what_it_is_not": ["Not executable tools (that is OpenToolsHub).", "Not eval harnesses (that is OpenHubForAI).",
        ...
        "relationship": "OpenSkillsHub teaches agents HOW. Skills USE tools from OpenToolsHub, are PROVEN by "
                        "OpenHubForAI, draw context from OpenContextHub, and run via Teleon.",
        "sections": [
    ...
    "opentoolshub": {
        ...
        "what_it_is_not": ["Not skill reasoning instructions (that is OpenSkillsHub).", "Not context truth.",
                           "Not eval rubrics (that is OpenHubForAI).", "Not a runtime."],
        ...
        "relationship": "OpenToolsHub gives executable capabilities. Tools are invoked by OpenSkillsHub skills, "
                        "PROVEN by OpenHubForAI, and orchestrated by Teleon.",
        "sections": [
    ...
    "openhubforai": {
        "title": "OpenHubForAI", "accent": "#d2542f", "kind": "OpenHubForAI.io · open harness ecosystem",
        ...
        "relationship": "OpenHubForAI PROVES capabilities work. It evaluates context (OpenContextHub), skills "
        ...
        "sections": [
            ...
            ("Preferred site", "OpenHubForAI.io replaces OpenHubForAI.org as the preferred public site."),
        ...
        "required_phrases": ["Open harnesses, rubrics, templates, and evals for agentic infrastructure.",
                             ...
                             "OpenHubForAI.io replaces OpenHubForAI.org", "Browse the harness ecosystem"],
...
<p class="lead">OpenHubForAI → Teleon → Baltor. One coordinated portfolio.</p></div>
