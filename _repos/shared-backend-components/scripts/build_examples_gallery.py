...
Each card on the page is the ACTUAL output of a `_repos/shared-backend-components/scripts/showcase_pipelines/*.py` pipeline — the
...
Run:  python3 _repos/shared-backend-components/scripts/build_examples_gallery.py [--self-test]
"""
...
_ACCENT = "#5b6cff"
_OUT = _resource("dist/examples-gallery/index.html")
