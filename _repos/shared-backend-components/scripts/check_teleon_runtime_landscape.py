"""check_teleon_runtime_landscape — proof for _repos/shared-backend-components/architecture/teleon_runtime_landscape.json.
...
_DOC = _resource("architecture") / "teleon_runtime_landscape.json"
