#!/usr/bin/env python3
"""scripts.check_no_uncataloged_github_repos — proof (C35): inside the GOVERNED runtime scope (_repos/baltor/backend/src/baltor +
_repos/shared-backend-components/scripts/{runtime,artifact_graph,llm_gateway,security}), every imported 3rd-party package must have an adapter
...
CLI: python3 _repos/shared-backend-components/scripts/check_no_uncataloged_github_repos.py --self-test
"""
...
_GOVERNED = ["_repos/baltor/backend/src/baltor", "scripts/runtime", "scripts/artifact_graph", "scripts/llm_gateway", "scripts/security"]
