...
*pipeline* · `pipeline/beneficial-owner-sanctions-chain-screening` · v0.1.0 · experimental
...
| 10 | `escalate` | processor | `processor/escalate-human-review` | $.steps.screen_counterparty.output.matches != [] || $.steps.screen_chain_nodes.output.matches != [] |
