# Authority fetch diff (fetch the cited authoritative URL and diff it against the internal claim)

*processor* · `processor/authority-fetch-diff` · v0.1.0 · experimental
