...
*harness* · `harness/clinical-coding-audit-review` · v0.1.0 · experimental
...
**Contributes to:** `pipeline/clinical-coding-audit-review`, `benchmark/clinical-coding-audit-bench`
