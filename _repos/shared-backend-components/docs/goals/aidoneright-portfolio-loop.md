...
- baltor_service
- teleon_service
- openhubforai_projection_service
...
- `scripts/check_openhubforai_projection_only_access.py`
...
- `_repos/aidoneright/context/handoff/handoff-freshness.md`
- `_repos/aidoneright/context/handoff/claude-code-max-transfer.md`
- `_repos/aidoneright/context/handoff/codex-transfer.md`
- `_repos/openhubforai/context/handoff/openhub-surface-counts.md`
