...
1. **`_repos/_shared/codex/yc-readiness-handoff-2026-06-13.md`** — the complete current state: what the audit
...
3. **`docs/research/agent-governance-landscape-2026-06-13.md`** — the sharpened wedge (govern TRUTH, not
   ...
   in weeks).
4. **`docs/strategy/teleon-baltor-openhubforai-portfolio.md`** + `architecture/brand.json` — the locked
