...
The canonical master goal is `_repos/_shared/codex/master-goal.md`. This file crystallizes
...
> **OpenHubForAI + 21 OpenHubForAI registries** (open ecosystem + substrate), under the **AI Done Right**
...
→ `_repos/shared-backend-components/context/strategy/corpus-acquisition-grid-spec.md`, `scripts/acquisition/`.
...
→ `_repos/shared-backend-components/context/strategy/gap-detection-screen-spec.md`, `scripts/acquisition/gap_screen.py`.
