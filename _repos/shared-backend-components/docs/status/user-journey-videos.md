...
`artifacts/e2e/videos/journey-1-openhubforai.mp4` · 101s · 25 chapters · against `expansion-cat-manual-podcasts.trycloudflare.com`

| t | chapter |
|---|---|
| 6s | OpenHubForAI.io — live on the public link: expansion-cat-manual-podcasts.trycloudflare.com |
...
| 101s | OpenHubForAI — fully wired: live registry, live builds, real accounts, real exports |
...
| 107s | The open funnel: 8 live registries + the OpenHubForAI product, one design system, real accounts everywhere |
...
## OpenHubForAI.io — live open registry: fully wired (real account · workspace · keys)

`artifacts/e2e/videos/site-openmcphub.mp4` · 35s · 10 chapters

| t | chapter |
|---|---|
| 4s | OpenHubForAI.io — open registry (live) |
| 10s | Browse the registry |
| 11s | An entry — provenance, signing, install command |
| 15s | A REAL account on this site’s own identity realm (no SSO) |
| 18s | Real register → session |
...
| 28s | Minting a REAL key (shown once, hash-only at rest) |
| 34s | Billing (EMULATED — no charges) |
| 35s | OpenHubForAI.io — fully wired: real account, real workspace, real keys |
