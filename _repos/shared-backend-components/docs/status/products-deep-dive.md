# Products deep dive — Baltor · Teleon · OpenHubForAI and everything they touch
...
identity validate (9410). Library spine `_repos/teleon/backend/src/teleon/*` (purpose_tasks, agent_gateway, OIPS
...
flowchart LR
  ...
  ADM --> OIPS[_repos/teleon/backend/src/teleon OIPS gateway]
