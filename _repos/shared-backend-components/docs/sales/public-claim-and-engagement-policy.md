...
> Guard: `_repos/baltor/backend/src/baltor/sales/claim_guard.py`. Proof (redteam): `scripts/check_sales_guardrails.py`.
...
## Status of the larger build (see `_repos/aidoneright/context/portfolio-sales-lead-funnel-and-problem-proof-tools.md`)
