...
3. `_repos/baltor/context/architecture/baltor-codebase-cleanup-plan.md`
4. `_repos/baltor/context/architecture/baltor-model-and-document-pipeline.md`
5. `_repos/baltor/context/architecture/baltor-stateless-worker-standard.md`
6. `_repos/baltor/context/architecture/baltor-queue-priority-orchestration.md`
7. `_repos/baltor/context/architecture/baltor-source-trust-and-adoption-policy.md`
8. `_repos/fundraising/context/baltor-gtm-fundraising-plan.md`
