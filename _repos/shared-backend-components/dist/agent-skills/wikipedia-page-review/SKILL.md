---
name: wikipedia-page-review
description: Given the text of a Wikipedia article (English Wikipedia, v0.1.0), produce
  a per-policy-pillar quality assessment with per-finding severity, exact quote, section
  pointer, and suggested edit.
...
- **persona**: persona/wikipedia-quality-reviewer
- **model_adapter**: adapter/ollama-default
- **rule_packs**: `rule-pack/grep-wikipedia-quality-flags`

## Success criteria

- rubric `rubric/wikipedia-article-quality-v1` threshold 0.7

## Provenance

- Hub component: `pipeline/wikipedia-page-review` v0.1.0
- License: `MIT`
