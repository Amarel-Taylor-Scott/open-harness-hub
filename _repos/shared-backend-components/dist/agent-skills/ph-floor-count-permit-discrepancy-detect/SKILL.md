---
name: ph-floor-count-permit-discrepancy-detect
description: Detect Philippine building-permit red flags (approved-vs-actual floor
  count, missing licensed-engineer sign-off, occupied-without-CO, missing/expired
  FSIC) on a building case packet and route each flag to the correct authority with
  PD 1096 / RA 9514 citations; abstain when the approved floor count is not human-verified.
...
- **knowledge_packs**: `knowledge-pack/national-building-permit-and-occupancy-procedures-low-digitization`, `knowledge-pack/building-code-inspection-frameworks`
...
- Hub component: `pipeline/ph-floor-count-permit-discrepancy-detect` v0.1.0
- License: `MIT`
