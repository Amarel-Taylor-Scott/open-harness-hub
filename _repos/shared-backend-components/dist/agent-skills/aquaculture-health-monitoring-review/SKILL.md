---
name: aquaculture-health-monitoring-review
description: Review aquaculture health packets for mortality, water quality, treatment,
  stocking density, and biosecurity evidence.
...
- **persona**: persona/aquaculture-health-reviewer
- **model_adapter**: adapter/ollama-default
- **knowledge_packs**: `knowledge-pack/aquaculture-health-monitoring-frameworks`
- **rule_packs**: `rule-pack/grep-aquaculture-health-monitoring-flags`, `rule-pack/rag-aquaculture-health-monitoring-retrieval-policy`

## Success criteria

- rubric `rubric/aquaculture-health-monitoring-quality-v1` threshold 0.7
- deterministic `$.steps.redaction_audit.output.result.pass` == `True`
- deterministic `$.steps.check_citations.output.result.pass` == `True`

## Provenance

- Hub component: `pipeline/aquaculture-health-monitoring-review` v0.1.0
- License: `MIT`
