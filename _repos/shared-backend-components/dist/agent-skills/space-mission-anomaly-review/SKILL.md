---
name: space-mission-anomaly-review
description: Review mission anomaly packets for telemetry, fault-tree evidence, safety
  impact, conjunction risk, and corrective action.
...
- **persona**: persona/space-anomaly-reviewer
- **model_adapter**: adapter/ollama-default
- **knowledge_packs**: `knowledge-pack/space-mission-anomaly-frameworks`
- **rule_packs**: `rule-pack/grep-space-mission-anomaly-flags`, `rule-pack/rag-space-mission-anomaly-retrieval-policy`

## Success criteria

- rubric `rubric/space-mission-anomaly-quality-v1` threshold 0.7
- deterministic `$.steps.redaction_audit.output.result.pass` == `True`
- deterministic `$.steps.check_citations.output.result.pass` == `True`

## Provenance

- Hub component: `pipeline/space-mission-anomaly-review` v0.1.0
- License: `MIT`
