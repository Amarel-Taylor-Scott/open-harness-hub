---
name: contract-renewal-risk-cite-or-abstain
description: Given a commercial contract plus an account packet, surface renewal-risk
  findings (auto-renewal, notice window, price escalator, termination, assignment,
  value-realization gaps) where EACH finding cites the clause span or renewal-risk
  framework entry that grounds it, or abstain. Publication is blocked unless citation
  coverage and the hallucination score clear threshold.
...
- **knowledge_packs**: `knowledge-pack/contract-law-clauses`, `knowledge-pack/customer-renewal-risk-frameworks`
- **rule_packs**: `rule-pack/privacy-pii-text-en`, `rule-pack/grep-customer-renewal-risk-flags`, `rule-pack/hybrid-retrieval-policy`

## Success criteria

- rubric `rubric/customer-renewal-risk-quality-v1` threshold 0.68
- deterministic `$.steps.check_citations.output.result.pass` == `True`
- deterministic `$.steps.citation_coverage.output.coverage` >= `0.9`
- deterministic `$.steps.redaction_audit.output.result.pass` == `True`

## Provenance

- Hub component: `pipeline/contract-renewal-risk-cite-or-abstain` v0.1.0
- License: `MIT`
