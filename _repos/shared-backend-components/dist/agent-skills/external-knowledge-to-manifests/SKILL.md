---
name: external-knowledge-to-manifests
description: Given an external knowledge source (walker_kind + walker_inputs), walk
  it, propose OHH draft manifests per node, validate, self- revise on failure, and
  write curator-ready drafts to `catalog/_inbox/`.
when_to_use: 'Pipeline kind: ingest.'
---
...
- rubric `rubric/draft-manifest-quality-v1` threshold 0.7

## Provenance

- Hub component: `pipeline/external-knowledge-to-manifests` v0.1.0
- License: `MIT`
