...
description: Split OpenHubForAI object generation into parallel container worker lanes
  with source governance, shard leasing, enrichment, validation, promotion, warehouse
  export, and prompt-prefix cache normalization.
