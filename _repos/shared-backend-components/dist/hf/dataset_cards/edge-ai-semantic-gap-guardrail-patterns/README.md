...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/edge-ai-semantic-gap-guardrail-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: User-provided defensive architecture seed on encoded-payload semantic gaps, OpenHubForAI component design notes
