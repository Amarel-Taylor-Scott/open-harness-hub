...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/use-case-seed-entity-ref-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI use-case seed row exporter, OpenHubForAI source governance and entity resolution architecture
