...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/local-pgvector-embedding-smoke-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI local pgvector embedding smoke planner, OpenHubForAI pgvector embedding load planner, OpenHubForAI embedding committed load audit
