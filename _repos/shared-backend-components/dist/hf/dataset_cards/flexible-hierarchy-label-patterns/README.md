...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/flexible-hierarchy-label-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI hybrid label and dimensional search architecture
