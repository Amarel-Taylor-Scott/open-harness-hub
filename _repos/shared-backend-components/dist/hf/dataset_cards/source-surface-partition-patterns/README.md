...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/source-surface-partition-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI source-surface planning notes, Public source families listed in docs/codex/million-object-goal.md
