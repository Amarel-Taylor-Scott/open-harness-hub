...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/task-marketplace-archetype-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: Synthetic marketplace task archetypes based on common public task categories, OpenHubForAI primitive source surface map
