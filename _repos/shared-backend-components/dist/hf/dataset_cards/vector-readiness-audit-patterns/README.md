...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/vector-readiness-audit-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI embedding execution plan, OpenHubForAI pgvector and hybrid search architecture
