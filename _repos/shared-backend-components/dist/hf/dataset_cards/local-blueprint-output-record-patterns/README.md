...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/local-blueprint-output-record-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: User-provided OpenHubForAI local sentence-to-pipeline product direction from 2026-05-25, OpenHubForAI costed blueprint route matrix architecture
