...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/theory-to-component-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI user-provided technical theory and postmortem seeds, OpenHubForAI component factory patterns
