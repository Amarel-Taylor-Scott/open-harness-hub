...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/pgvector-embedding-load-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI pgvector embedding load planner, OpenHubForAI local hash embedding worker, OpenHubForAI Postgres schema
