...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/syndromic-surveillance-case-definitions` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **collected_by**: OpenHubForAI research agent (manual curation from public-domain WHO sources)
