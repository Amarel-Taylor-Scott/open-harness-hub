...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/dedupe-resolution-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI dedupe cluster schema, OpenHubForAI active component promotion plan
