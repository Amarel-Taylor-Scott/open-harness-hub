...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/duplicate-collapse-report-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI daily partition load audit, OpenHubForAI model-ops daily run, OpenHubForAI index coverage repair planner
