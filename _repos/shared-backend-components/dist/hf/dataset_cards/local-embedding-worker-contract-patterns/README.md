...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/local-embedding-worker-contract-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI local embedding worker contract, OpenHubForAI vector readiness audit, OpenHubForAI daily embedding execution planner
