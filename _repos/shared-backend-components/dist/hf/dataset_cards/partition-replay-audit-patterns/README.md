...
<!-- Generated from OpenHubForAI manifest `knowledge-pack/partition-replay-audit-patterns` v0.1.0. Edit the source manifest and re-run `python scripts/emit/hf_dataset_card.py`. -->
...
- **sources**: OpenHubForAI partitioned index delta architecture, OpenHubForAI incremental catalog build architecture
