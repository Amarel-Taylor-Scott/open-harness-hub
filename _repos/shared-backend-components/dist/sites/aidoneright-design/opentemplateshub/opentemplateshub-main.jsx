...
// harnesses prove the generated outputs work." Distinct from OpenHubForAI
...
const App = makeHub({
  ...
  howBody: <>Pick a <strong>template family</strong> — schema, runtime, resource, API-UI, inference or PurposeTask — and
    ...
    <strong> harness</strong> from OpenHubForAI to prove it passes its eval. Shape here, proof there.</>,
  features: [
