...
Entry: **`Teleon.html`** → open in a browser.

## Files
| File | Responsibility |
|---|---|
| `Teleon.html` | Shell: loads shared tokens/components/**oh-site.css** + `teleon.css`, then React/Babel, `products.js`, **`../shared/oh-site.jsx`**, `teleon-main.jsx`. |
