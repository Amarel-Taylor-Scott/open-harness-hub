...
| Baltor.ai | live | `#0e7c86` | `context-enrichment/Context Enrichment.html` |
| Teleon.dev | live | `#6d5ef0` | `teleon/Teleon.html` |
| OpenContextHub | live | `#2f8f6b` | `opencontexthub/OpenContextHub.html` |
| OpenSkillsHub | live | `#2f7d8f` | `openskillshub/OpenSkillsHub.html` |
| OpenToolsHub | live | `#8f6f2f` | `opentoolshub/OpenToolsHub.html` |
| OpenSkillToTool | live | `#cf5a96` | `openskilltotool/OpenSkillToTool.html` |
| OpenMCPHub | live | `#5b7cf0` | `openmcphub/OpenMCPHub.html` |
| OpenCompressionHub | live | `#9bd61f` | `opencompressionhub/OpenCompressionHub.html` |
| OpenBenchmarkHub | live | `#e0556a` | `openbenchmarkhub/OpenBenchmarkHub.html` |
| OpenReviewHub | live | `#9d4edd` | `openreviewhub/OpenReviewHub.html` |
| OpenHubForAI | live | `#d2542f` | `openhubforai/OpenHubForAI.html` |
| OpenTemplatesHub | **private** | `#6d6a86`→`#7c5cff` | `opentemplateshub/OpenTemplatesHub.html` |
| OpenEndpointHub | **private** | `#5f7585`→`#1f8fd6` | `openendpointhub/OpenEndpointHub.html` |
| OpenEnvHub | **private** | `#5f7a6e`→`#2f9e5a` | `openenvhub/OpenEnvHub.html` |
| OpenSandboxHub | **private** | `#7a6f86`→`#b5562f` | `opensandboxhub/OpenSandboxHub.html` |
| OpenAgentHub | **private** | `#7a7460`→`#0f9e8e` | `openagenthub/OpenAgentHub.html` |
| OpenReceiptHub | **private** | `#72786b`→`#c79a2e` | `openreceipthub/OpenReceiptHub.html` |
| OpenStateHub | **private** | `#6c6f86`→`#0ea5a5` | `openstatehub/OpenStateHub.html` |
| OpenReconciliationHub | **private** | `#6a7080`→`#2f6fae` | `openreconciliationhub/OpenReconciliationHub.html` |
| OpenHardeningHub | **private** | `#7a6f6a`→`#b5562f` | `openhardeninghub/OpenHardeningHub.html` |
| OpenEnrichmentHub | **private** | `#6a7a72`→`#2f9e7a` | `openenrichmenthub/OpenEnrichmentHub.html` |
| OpenOptimizationHub | **private** | `#76707f`→`#c8902f` | `openoptimizationhub/OpenOptimizationHub.html` |
| OpenVerificationHub | **private** | `#6f7a80`→`#1f9b8e` | `openverificationhub/OpenVerificationHub.html` |
...
- `openhubforai/PAGES.md` — OpenHubForAI route catalog.
