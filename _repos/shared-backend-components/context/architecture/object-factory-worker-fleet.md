...
For the horizontal multi-container version, see the **Containerized worker
orchestration** section of
[`evidence-driven-component-factory.md`](evidence-driven-component-factory.md)
(which absorbed the containerized-object-factory-orchestration plan).
