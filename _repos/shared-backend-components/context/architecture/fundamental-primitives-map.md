...
- **implemented by:** `_repos/teleon/backend/src/teleon/io/governed_record.py`, `_repos/teleon/backend/src/teleon/resources/resource_ref.py`, `schemas/io`, `schemas/shared`
...
- **implemented by:** `_repos/baltor/backend/src/baltor/native/native_format_preserver.py`, `_repos/baltor/backend/src/baltor/native/okf_adapter.py`, `_repos/baltor/backend/src/baltor/native/ftm_adapter.py`, `schemas/native`, `schemas/envelopes`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/io/event_io.py`, `_repos/teleon/backend/src/teleon/io/work_io.py`, `_repos/teleon/backend/src/teleon/egress`, `architecture/egress_route_policy_taxonomy.json`, `schemas/egress`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/runtime/execution_provider.py`, `_repos/teleon/backend/src/teleon/workers`, `_repos/teleon/backend/src/teleon/inference`, `_repos/teleon/backend/src/teleon/io/inference_io.py`
...
- **implemented by:** `architecture/standards_interop_manifest.json`, `_repos/baltor/backend/src/baltor/observability/projections/standards.py`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/purpose_tasks/purpose_task.py`, `_repos/teleon/backend/src/teleon/digestion`, `_repos/teleon/backend/src/teleon/seeds`, `schemas/purpose_tasks`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/runtime/execution_backend_selector.py`, `_repos/teleon/backend/src/teleon/runtime/execution_providers`, `architecture/execution_backend_policy_matrix.json`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/workers/execution_providers/local_job_emulator.py`, `architecture/execution_backend_policy_matrix.json`, `scripts/check_real_execution_candidates_have_emulators.py`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/runtime/execution_providers/gcp_cloud_run_function_candidate.py`, `local_emulators/model_emulator.py`, `local_emulators/source_of_truth_emulator.py`, `scripts/check_local_function_emulator.py`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/environments`, `architecture/execution_environment_profiles.json`, `schemas/environments`, `schemas/runtime`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/lift`, `scripts/eval/reason_codes.py`, `scripts/eval/durable_gap_harness.py`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/evolution/freshness_runtime.py`, `_repos/teleon/backend/src/teleon/self_healing`, `local_emulators/source_of_truth_emulator.py`
...
- **implemented by:** `schemas/observability`, `_repos/baltor/backend/src/baltor/observability/projections/standards.py`, `scripts/check_live_ofac_receipt.py`
...
- **implemented by:** `_repos/teleon/backend/src/teleon/governance/org_policy.py`, `architecture/org_guardrail_policies.json`, `architecture/portfolio_dependency_law.json`
