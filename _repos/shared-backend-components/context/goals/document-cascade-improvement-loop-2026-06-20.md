...
**Run it (pick one):**
- One increment in a session: `/goal follow the instructions in _repos/shared-backend-components/context/goals/document-cascade-improvement-loop-2026-06-20.md`
...
- **GTM / business** — competitor analysis, hosting/cloud/K8s/serverless/model costs, worker economics, pricing,
  marketing budget, pro-forma financials, fundraising, launch ops (see `_repos/fundraising/context/baltor-gtm-fundraising-plan.md`).
...
`_repos/teleon/backend/src/teleon/extraction/schema_templates.py` (proof: `scripts/check_schema_templates.py`). Any new "write in a
