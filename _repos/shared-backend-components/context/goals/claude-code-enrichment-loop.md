...
```
/loop 30m Run ONE cycle of the Claude Code whole-surface enrichment loop per _repos/shared-backend-components/context/goals/claude-code-enrichment-loop.md.
```
