...
- Store into: the registry federation (`architecture/registry_ontology.json`) via `_repos/teleon/backend/src/teleon/registry/populate.py`
  + enrich via `_repos/teleon/backend/src/teleon/registry/enrich.py`.
