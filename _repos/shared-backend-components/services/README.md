...
services/
  ...
  products/
    harness_hub/entrypoint.py        OpenHubForAI (request) — serves _repos/openhubforai/frontend/ (OH_PRODUCT pin)
    baltor/entrypoint.py Baltor / Baltor (request) — serves _repos/baltor/frontend/
