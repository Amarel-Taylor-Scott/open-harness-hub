...
spec). Canonical: `docs/strategy/teleon-baltor-openhubforai-portfolio.md`, visual map at `dist/architecture/index.html`.
...
- **Primitives → harnesses → pipelines → benchmarks** — the four layers. See [Layers & primitives](../../shared-backend-components/docs/concepts/layers.md).
- **The seven primitives** — Input · Knowledge Corpus · If Statement · Action · Loop · Stop/End · Output. A persona,
  tool, processor, harness, or rubric is all an **Action**. See [Taxonomy](../../shared-backend-components/docs/concepts/taxonomy.md).
- **Pre-API / API / post-API processes** — what happens before, during, and after a model call (intake/normalize/route
  → the call → verify/score/review). See [Pre/post-API processes](../../shared-backend-components/docs/concepts/pre-post-api.md).
- **Multimodal pipelines** — text, image, audio, video components in the same graph. See [Multimodal pipelines](../../shared-backend-components/docs/concepts/multimodal.md).
- **The capability-gap lens** — we build for the **negative space** where base models lack capability, not the head of
  the distribution. See [Capability valleys](../../shared-backend-components/docs/concepts/capability-valleys.md).
...
[Compiling capabilities into bounded DAGs](../../shared-backend-components/docs/concepts/compiling-capabilities-into-bounded-dags.md).
...
Three **storage tiers**, each fit for purpose (`_repos/teleon/backend/src/teleon/storage/record_store.py`, `architecture/storage_tier_policy.json`):
...
[Database representations](../../shared-backend-components/docs/concepts/databases.md).
...
- **Dependency law** — Baltor → Teleon → OpenHubForAI, never the reverse.
...
| Area | Start here |
|---|---|
| Concepts: layers & primitives | [layers.md](../../shared-backend-components/docs/concepts/layers.md) · [taxonomy.md](../../shared-backend-components/docs/concepts/taxonomy.md) · [pre-post-api.md](../../shared-backend-components/docs/concepts/pre-post-api.md) · [multimodal.md](../../shared-backend-components/docs/concepts/multimodal.md) |
| The compiler (sentence → DAG) | [compiling-capabilities-into-bounded-dags.md](../../shared-backend-components/docs/concepts/compiling-capabilities-into-bounded-dags.md) |
...
| Tools & uniform invoke | `archive/legacy/docs/strategy/component-standardization-and-dag-verification-2026-06.md` · [tool planes](../../shared-backend-components/docs/concepts/taxonomy.md) |
