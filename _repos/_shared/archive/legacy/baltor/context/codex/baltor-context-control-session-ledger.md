...
- Continue the admin-demo implementation and test loop from
  `_repos/baltor/context/codex/baltor-context-control-iteration-plan.md`.
...
- Updated `_repos/baltor/context/codex/baltor-context-control-iteration-plan.md` to include the
...
- Updated:
  ...
  - `_repos/baltor/context/codex/baltor-context-control-test-plan.md`.
...
- Added local client/SDK path documentation:
  - `_repos/baltor/context/codex/baltor-claude-code-context-kit.md`
- Updated docs:
  - `docs/codex/baltor-context-control-current-state.md`;
  - `_repos/baltor/context/codex/baltor-context-control-test-plan.md`;
  - `docs/architecture/baltor-mcp-context-gateway.md`.
...
- Updated `_repos/baltor/context/codex/baltor-claude-code-context-kit.md` to include the cache
...
- Updated `.claude/skills/baltor-context-gateway/SKILL.md` and
  `_repos/baltor/context/codex/baltor-claude-code-context-kit.md` to document the offline
  status/read path.
