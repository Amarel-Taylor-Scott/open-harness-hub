...
**`_repos/baltor/context/baltor-purpose-driven-cloud-task-runtime.md`**
...
live under `_repos/baltor/backend/src/baltor/purpose_tasks/` + `schemas/purpose_tasks/PurposeTaskSpec` (flywheel 316). Use the
