<!-- ARCHIVED 2026-07-03: this is the duplicate north-star mission-prompt prefix that was prepended to
docs/codex/claude-fable-compiled-primitive-routes-handoff.md (lines 1-2697). It was trimmed out of that
handoff so the live file carries only its compiled-primitive-routes payload. Preserved here losslessly. -->
