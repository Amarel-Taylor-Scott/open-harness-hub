...
| `_repos/_shared/strategy/product-market-monetization-brief.md` | Added "Build-on-demand & demand capture" subsection (free-funnel exports vs live/recurring layer; capability-requests; contributor credits) + build-on-demand in the usage-add-ons pricing row. |
...
- `_repos/_shared/codex/master-goal.md` — the one goal (foundation + consistency > volume).
...
- `_repos/_shared/strategy/product-market-monetization-brief.md` — **the canonical
