...
The "behind the login" architecture for the portfolio. The public marketing sites were specced in
`_repos/_shared/archive/legacy/aidoneright/context/portfolio-site-build-brief.md` (archived); THIS brief is the **product** — what users see and manage after they
...
- **Many projection consoles exist but are UNAUTHENTICATED demos:** `_repos/baltor/frontend/{dashboard,reviews,fleet,
  demo-console,consume,integrate,...}.html`, `_repos/openhubforai/frontend/pages/{admin,govern,build,catalog,auth}.js`,
