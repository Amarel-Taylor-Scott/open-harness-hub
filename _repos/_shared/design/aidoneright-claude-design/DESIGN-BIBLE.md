...
> **`_repos/_shared/design/aidoneright-claude-design/DESIGN-ASSETS.md`**. Upload that file alongside this one and
...
- **JSX compiled in the browser.** Each app file is a `<script type="text/babel">`, so there is no build step in the
  ...
  `_repos/_shared/design/aidoneright-claude-design/HANDOFF.md`).
