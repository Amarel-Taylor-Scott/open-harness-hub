...
| **`_repos/shared-backend-components/docs/DESIGN-BIBLE.md`** | the design system guide: tokens, type, every component, the two layouts (marketing top-nav and the `OhAppShell` left-sidebar logged-in shell), routes, governance, copy rules |
...
| **`_repos/shared-backend-components/docs/INTEGRATION-BIBLE.md`** | how a frontend talks to a backend (same-origin seams), local and cloud |
...
5. **`_repos/shared-backend-components/docs/DESIGN-BIBLE.md`** (the design system you build inside).
6. **`DESIGN-ASSETS.md`** (the source you reuse; do not reinvent the kit).
7. **`_repos/shared-backend-components/docs/INTEGRATION-BIBLE.md`** (the API seams the app calls).
...
2. **`INTEGRATION-HANDOFF.md`**: a README that explains how to merge your work into `_repos/aidevobserver/frontend/` without
