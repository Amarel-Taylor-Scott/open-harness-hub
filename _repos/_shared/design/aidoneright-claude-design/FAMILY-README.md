...
> 1. `_repos/shared-backend-components/docs/DESIGN-BIBLE.md` (the guide: tokens, type, every component, layouts, routes, governance, copy rules, the designer task)
> 2. `_repos/_shared/design/aidoneright-claude-design/DESIGN-ASSETS.md` (the actual SOURCE, verbatim: the full shared kit CSS and React components plus one complete app)
> 3. `_repos/shared-backend-components/docs/INTEGRATION-BIBLE.md` (how the frontends talk to backends, local and cloud)
>
...
| **AIDevObserver** | `#b25fd6` | watches AI USAGE, reviews the SESSION (post) plus intra-session | (local showcase; tunnel ephemeral) |
