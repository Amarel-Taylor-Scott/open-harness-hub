...
> **This is the single canonical goal — the single entry point.** An agent (Claude Code / Codex) reads
...
> and any other goal/runbook doc disagree, **this doc wins**; fix the other. Its two companion headline
> consolidations point back here as the entry point: **`../OVERARCHING-GOAL.md`** (the one-page mission
> summary a component owner reads first) and **`../PRODUCT-MARKET-FIT.md`** (the consolidated PMF thesis).
>
> **North Star v2 (2026-05-29) — superseded, kept for lineage:** an earlier "two products" framing (an OHH
> governed-harness *funnel* + a verified-context service as the *business*) once lived in `north-star.md`;
> that doc is now archived at `archive/legacy/_shared/codex/north-star.md` and its two-products framing is
> **superseded by North Star v3 below** (the three-layer portfolio). This component-registry mission remains
> the **substrate**; this doc leads on the substrate + usefulness bar.
>
...
> `docs/strategy/teleon-baltor-openhubforai-portfolio.md`; visual map: `docs/strategy/architecture-map.md`;
...
From `_repos/openhubforai/context/about/project.md`, promoted to hard gates:
...
- **Do:** keep the validator green and stats fresh (done this cycle); finish the
  ...
  `_repos/_shared/strategy/product-market-monetization-brief.md` (named competition,
...
- `million-object-goal.md` → *superseded*; **archived** at `archive/legacy/_shared/codex/million-object-goal.md` (history only).
