...
the eight one-page composition recipes with install paths — see [index.md](../../shared-backend-components/docs/use-cases/index.md).
...
([recipe](../../shared-backend-components/docs/use-cases/human-trafficking-ugc-detection.md)) redacts PII before any inference,
runs deterministic GREP If Statements in order (CSAM-route first, so suspected
...
([recipe](../../shared-backend-components/docs/use-cases/esg-supply-chain-due-diligence.md)) flattens structured disclosures to
prose, fires three deterministic GREP If Statements (forced-labor / environmental
...
is a *deterministic-If Statement* result, not an end-to-end lift number; the
...
([recipe](../../shared-backend-components/docs/use-cases/clinical-decision-support.md)) redacts PHI (HIPAA Safe Harbor), screens
clinical red-flags as a deterministic If Statement (ACS, stroke, SAH, anaphylaxis,
...
[refugee-bureaucracy-translation.md](../../shared-backend-components/docs/use-cases/refugee-bureaucracy-translation.md).)
...
**The governed pipeline (OHH).** Deterministic If Statements pin the controlled
...
| **Recurring vs. freezable** | freezable If Statements/retrieval/citation gates; pay model cost for the one Action call | raw + compressed are freezable; live-served + CDC-fresh is recurring |
...
- [index.md](../../shared-backend-components/docs/use-cases/index.md) — the recipe-level catalog of eight starter use cases with install
...
([human-trafficking-ugc-detection.md](../../shared-backend-components/docs/use-cases/human-trafficking-ugc-detection.md),
[esg-supply-chain-due-diligence.md](../../shared-backend-components/docs/use-cases/esg-supply-chain-due-diligence.md) incl. the
real `data/esg-grep-findings.json` test, [clinical-decision-support.md](../../shared-backend-components/docs/use-cases/clinical-decision-support.md),
[refugee-bureaucracy-translation.md](../../shared-backend-components/docs/use-cases/refugee-bureaucracy-translation.md)),
...
no invented metrics, canonical vocabulary (Knowledge Corpus / If Statement /
Action).*
