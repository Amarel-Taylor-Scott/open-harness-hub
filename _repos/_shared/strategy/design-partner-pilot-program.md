...
§3.3 demo ladder, §4.2 pricing, §8 90-day plan) · `_repos/aidoneright/context/strategy/brand-architecture.md` (brand, LOCKED) ·
`_repos/baltor/context/strategy/first-live-capability-sanctions-screening.md` (first live capability) ·
`_repos/teleon/backend/src/teleon/verticals/provider_directory.py` + `provider_sources.py` (starter vertical).
