...
assembling and operating AI pipelines. Domain: `openhubforai.com`.
...
folders** — `_repos/openhubforai/frontend/` and `_repos/baltor/frontend/`, each self-contained, with the backend
