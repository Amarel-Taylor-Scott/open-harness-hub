...
const FITS = [
  ['OpenHubForAI is the open foundation.', 'An open registry of primitives, templates, context, tools, skills, and harnesses, with one shared vocabulary of parts. Every product draws from it.'],
  ['Teleon is the runtime.', 'It turns an open ended agent task into a deterministic, eval gated capability, using templates and skills from the open registry.'],
  ...
  ['AIDevObserver reviews usage.', 'It searches the same registry substrate while reviewing AI coding sessions, then turns findings into candidate reuse and primitive-refresh evidence.'],
];
function HowItFits() {
  return (
