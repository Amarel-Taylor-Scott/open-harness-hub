...
(`_repos/teleon/context/strategy/teleon-self-improving-runtime-vision.md`): the declared input the runtime gate + compiler
...
one. The registry-of-named-suites itself is the documented follow-up (see _repos/shared-backend-components/docs/architecture/eval-as-contract.md);
