...
_repos/teleon/context/architecture/purpose-task-self-adapting-execution.md.

This package is the minimal PoC of that motion, composed entirely from the built substrate
(_repos/teleon/backend/src/teleon/experiments/*) — no second runtime, ledger, or registry.
"""
