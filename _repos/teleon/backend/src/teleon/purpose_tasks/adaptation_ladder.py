...
Reads _repos/shared-backend-components/architecture/capability_adaptation_ladder.json (single source). DENY-BY-DEFAULT: an unknown change type
...
_LADDER_PATH = _resource("architecture") / "capability_adaptation_ladder.json"
