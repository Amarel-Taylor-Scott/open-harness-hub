...
This is the convert-skills/tools demo wired to the brain: for each capability in _repos/shared-backend-components/architecture/
...
registry (_repos/shared-backend-components/architecture/model_index.json) via substrate_selector, and each model_downgrade attempt records WHICH model
...
_CATALOG = _resource("architecture") / "modality_capability_catalog.json"
