...
CATALOG REFERENCES only (``_repos/shared-backend-components/architecture/agent_runtime_catalog.json``). Deterministic when ``now`` is injected.
...
from src.teleon.agents.agent_runtime_provider import (
    py_const_src_teleon_agents_agent_runtime_provider__AGENT_SERVES_TRUTH,
    py_const_src_teleon_agents_agent_runtime_provider__DEFAULT_AGENT_BUCKET,
    ...
    py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeResult,
    py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeUnavailableResult,
    py_function_src_teleon_agents_agent_runtime_provider__dispatch_agent_request,
)
...
DEFAULT_EXPLORATION_RUNTIME_ID = py_const_src_teleon_agents_agent_runtime_provider__LOCAL_EMULATOR_RUNTIME_ID
...
EXPLORATION_WORKER_BUCKET = py_const_src_teleon_agents_agent_runtime_provider__DEFAULT_AGENT_BUCKET  # == "open_ended_agent"
...
def _receipt(decision: EscalationDecision, request: py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeRequest, runtime_id: str, status: str,
...
def dispatch_exploration(
    ...
    *,
    ...
    request = py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeRequest(
    ...
    envelope = py_function_src_teleon_agents_agent_runtime_provider__dispatch_agent_request(
    ...
    if isinstance(result, py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeResult):
        status = "produced"
        ...
        assert isinstance(result, py_class_src_teleon_agents_agent_runtime_provider__AgentRuntimeUnavailableResult), (
    ...
    return ExplorationProposal(
        ...
        provenance=provenance, reenters_gate=True, serves_truth=py_const_src_teleon_agents_agent_runtime_provider__AGENT_SERVES_TRUTH)
