...
license string for the governance layer to classify (_repos/openhubforai/backend/src/openhubforai/licenses) + dedupe + verify before anything is
...
_UA = "OpenHubForAI-Teleon/0.1 (tool-discovery)"
...
#: _repos/shared-backend-components/architecture/browser_escalation_ladder.json (undetected_driver / vision_coordinate / proxy — governed, not wired).
