...
Runtime selection is a Teleon concern (_repos/shared-backend-components/architecture/portfolio_dependency_law.json migration_status, extraction
step 1). Baltor consumes this through a re-export shim at _repos/baltor/backend/src/baltor/ports/execution_provider.py — Baltor → Teleon
...
class py_class_src_teleon_runtime_execution_provider__ProviderUnavailableResult:
...
@dataclass(frozen=True)
class py_class_src_teleon_runtime_execution_provider__ExecutionResult:
    provider_id: str
    execution_id: str
    task_id: str
...
@runtime_checkable
class py_class_src_teleon_runtime_execution_provider__ExecutionProviderPort(Protocol):
    ...
    def estimate(self, py_arg_src_teleon_runtime_execution_provider__py_class_src_teleon_runtime_execution_provider__ExecutionProviderPort_estimate__task: dict, py_arg_src_teleon_runtime_execution_provider__py_class_src_teleon_runtime_execution_provider__ExecutionProviderPort_estimate__policy: dict) -> dict: ...
    def invoke(self, py_arg_src_teleon_runtime_execution_provider__py_class_src_teleon_runtime_execution_provider__ExecutionProviderPort_invoke__task: dict) -> Any: ...   # ExecutionResult or ProviderUnavailableResult
