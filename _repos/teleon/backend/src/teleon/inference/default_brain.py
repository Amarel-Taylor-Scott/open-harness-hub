...
most-bounded+most-efficient should itself run cheap by default. Reads _repos/shared-backend-components/architecture/default_brain_policy.json; auth
...
_POLICY = _resource("architecture") / "default_brain_policy.json"
