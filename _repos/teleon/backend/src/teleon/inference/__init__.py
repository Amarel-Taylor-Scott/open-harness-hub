...
existing LLM gateway (_repos/shared-backend-components/scripts/llm_gateway / _repos/shared-backend-components/scripts/model_gateway.py), which becomes the primary provider
