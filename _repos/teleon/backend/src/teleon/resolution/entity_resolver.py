...
Per-entity-type RULESETS (_repos/shared-backend-components/architecture/entity_resolution_rules.json) drive everything: each column is normalized (person
...
_RULES = _resource("architecture") / "entity_resolution_rules.json"
