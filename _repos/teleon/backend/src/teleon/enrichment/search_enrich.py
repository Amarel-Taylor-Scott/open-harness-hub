...
but picks the CHEAPEST provider that returns sources (_repos/shared-backend-components/architecture/search_provider_registry.json) and synthesizes with
...
_REGISTRY = _resource("architecture") / "search_provider_registry.json"
