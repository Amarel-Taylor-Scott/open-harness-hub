...
The runtime_class_guess values come FROM _repos/shared-backend-components/architecture/capability_runtime_classes.json (no reinvented vocabulary)
...
_RUNTIME_CLASSES_PATH = _resource("architecture") / "capability_runtime_classes.json"
