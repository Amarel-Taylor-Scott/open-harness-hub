...
the operator CLI _repos/shared-backend-components/scripts/repo_intake_strategize.py does the live GitHub fetch + writes the governed candidate feed):
...
_HUB_KEYWORDS = [
    ...
    ("harness", "OpenHubForAI"), ("eval", "OpenBenchmarkHub"), ("benchmark", "OpenBenchmarkHub"),
