...
``_repos/shared-backend-components/architecture/stateful_swarm_provider_catalog.json``). It exercises the full blackboard write / handoff /
...
class LocalStatefulSwarm:
    ...
    def __init__(self, *, blackboard: py_class_src_teleon_blackboard_local_sqlite_blackboard__LocalSqliteBlackboard | None = None, fixture: dict | None = None) -> None:
        self.blackboard = blackboard if blackboard is not None else py_class_src_teleon_blackboard_local_sqlite_blackboard__LocalSqliteBlackboard(db_path=":memory:")
