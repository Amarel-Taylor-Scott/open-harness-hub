...
A binding (in the shared registry _repos/shared-backend-components/architecture/tenant_objective_bindings.json) is either a named preset
...
#: repo root: this file is _repos/teleon/backend/src/teleon/objectives/tenant_binding.py -> parents[3] is the repository root.
_REGISTRY_PATH = _resource("architecture") / "tenant_objective_bindings.json"
