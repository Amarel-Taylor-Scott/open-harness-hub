...
Deterministic, offline (reads _repos/shared-backend-components/architecture/worker_bucket_registry.json). No wall-clock, no RNG.
"""
...
_REGISTRY = _resource("architecture") / "worker_bucket_registry.json"
