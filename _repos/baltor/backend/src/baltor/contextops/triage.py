...
``_repos/shared-backend-components/scripts/check_contextops_contracts.py``'s ``_TRIAGE_LANES``):
...
#: (Full graph-wide conflict detection lives in _repos/shared-backend-components/scripts/artifact_graph/conflict_detector.py; triage only
