...
LOSSLESS DISTILLATION (_repos/shared-backend-components/docs/codex/lossless-distillation.md): any transform is lossless at the system level —
...
``_repos/baltor/backend/src/baltor/adapters/memory/`` (baltor_local working provider, supermemory_emulator working offline
