...
const SURFACES = [
  ...
  { id: 'teleon', url: 'http://127.0.0.1:9210/teleon/' + encodeURIComponent('Teleon.html') },
  { id: 'control-tower', url: 'http://127.0.0.1:9000/' },
  { id: 'hub-opencontexthub', url: 'http://127.0.0.1:9210/opencontexthub/' + encodeURIComponent('OpenContextHub.html') },
  { id: 'hub-openreviewhub', url: 'http://127.0.0.1:9210/openreviewhub/' + encodeURIComponent('OpenReviewHub.html') },
  { id: 'hub-openroutinghub', url: 'http://127.0.0.1:9210/openroutinghub/' + encodeURIComponent('OpenRoutingHub.html') },
];
