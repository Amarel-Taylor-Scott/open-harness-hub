/* shared/oh-identity.js — realm-aware identity client for the full-design kit.
   ...
   - Base: window.OPENHUBFORAI_IDENTITY_BASE override, else the local default (matches the realm registry's
...
(function () {
  ...
  function base() { var b = window.OPENHUBFORAI_IDENTITY_BASE; return String(b == null ? DEFAULT_BASE : b).replace(/\/+$/, ""); }
  ...
  (function () {
    var EVENTS = (window.OPENHUBFORAI_EVENTS_BASE || "http://127.0.0.1:9420").replace(/\/+$/, "");
    var ANON = "oh-anon";
