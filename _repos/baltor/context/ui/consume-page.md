...
**Owner.** `_repos/baltor/frontend/consume.html` (served by `_repos/shared-backend-components/scripts/baltor_admin_demo_server.py` at `GET /consume`).
...
```
PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_consumption_ui.py --self-test
PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_demo_console_links.py --self-test
PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_architecture_dashboard_projection_only.py --self-test
