...
```text
_repos/shared-backend-components/docs/BIBLE.md
_repos/shared-backend-components/docs/DESIGN-BIBLE.md
_repos/shared-backend-components/docs/INTEGRATION-BIBLE.md
_repos/aidoneright/context/design/aidoneright-claude-design/START-HERE.md
_repos/shared-backend-components/docs/codex/ai-done-right-family-polish-goal.md
_repos/shared-backend-components/docs/architecture/service-auth-and-consumption-model.md
...
(`_repos/shared-backend-components/docs/design/aidoneright-claude-design/` plus the DESIGN and INTEGRATION bibles;
...
```bash
python3 _repos/shared-backend-components/scripts/baltor_context_cache.py \
...
```text
_repos/shared-backend-components/scripts/baltor_context_client.py
```
...
```bash
python3 _repos/shared-backend-components/scripts/baltor_context_cache_read.py \
...
_repos/shared-backend-components/scripts/baltor_context_cache.py
_repos/shared-backend-components/scripts/baltor_context_client.py
_repos/shared-backend-components/scripts/baltor_context_cache_read.py
