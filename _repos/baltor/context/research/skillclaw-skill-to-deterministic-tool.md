...
> [Determinism Factory](../../_repos/baltor/context/baltor-determinism-factory.md) applied to *skills*, gated like the
...
Machine-readable companion: [`_repos/shared-backend-components/architecture/skill_to_tool_promotion_catalog.json`](../../architecture/skill_to_tool_promotion_catalog.json).
Proof: `_repos/shared-backend-components/scripts/check_skill_to_tool_promotion.py --self-test`.
...
1. **It re-injects an evolved `SKILL.md` back into the probabilistic agent loop.** A better prompt is still a
   ...
   call it reliably (the [small-models + deterministic-harnesses](../../_repos/baltor/context/baltor-determinism-factory.md)
   thesis).
...
[`_repos/shared-backend-components/architecture/skill_to_tool_promotion_catalog.json`](../../architecture/skill_to_tool_promotion_catalog.json).
...
- **Determinism Factory** (`_repos/baltor/context/baltor-determinism-factory.md`). This IS that factory's M0->M8 ladder
...
- **Agent-gateway / deterministic-first token ladder.** A certified tool becomes a cheap deterministic rung the
  ...
  promoted tools.
- **Lossless Distillation law** (`_repos/shared-backend-components/docs/codex/lossless-distillation.md`). Every rung is a new versioned layer;
...
- **Skill Digestion Lab** (`_repos/shared-backend-components/docs/research/` + `_repos/shared-backend-components/scripts/check_skill_digestion.py`,
  `_repos/teleon/backend/src/teleon/digestion/`). That lab already digests an *expensive* skill into a cheaper deterministic runtime
...
- Repo laws: [`_repos/baltor/context/baltor-determinism-factory.md`](../../_repos/baltor/context/baltor-determinism-factory.md),
  [`_repos/shared-backend-components/docs/codex/lossless-distillation.md`](../codex/lossless-distillation.md),
  [`_repos/shared-backend-components/scripts/check_skill_digestion.py`](../../scripts/check_skill_digestion.py)
