...
>
> Machine-readable catalog: `_repos/shared-backend-components/architecture/context_engineering_tool_catalog.json`
> · proof: `_repos/shared-backend-components/scripts/check_context_engineering_tool_catalog.py --self-test`
> · governing laws: `_repos/shared-backend-components/docs/codex/lossless-distillation.md`, the change-verification contract.
> · **Distinct from** `_repos/shared-backend-components/architecture/context_compression_provider_catalog.json` (the PROXY-level /
...
(`_repos/baltor/backend/src/baltor/context_audit`) is *not* a new engine. It **composes the deterministic engines this repo
...
```
   ...
   └──────────────────────────────────────────────────────────────────────┘
                                   ...
                                   ▼
        ┌───────────────────────────────────────────────────────────┐
        │  1) CONTEXT AUDITOR        (_repos/baltor/backend/src/baltor/context_audit, MVP)  │
...
- **LOSSLESS dedupe / supersession.** Any tool whose value is "dedup / supersede / decay / compress"
  ...
  `_repos/shared-backend-components/docs/codex/lossless-distillation.md` *if we adopt its ideas*: **supersede ≠ delete.** The raw layer,
