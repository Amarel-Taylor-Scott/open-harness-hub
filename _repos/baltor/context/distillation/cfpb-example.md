...
Flow: `_repos/shared-backend-components/scripts/runtime/consumption.py` + `_repos/shared-backend-components/scripts/runtime/optimization.py` +
`_repos/shared-backend-components/scripts/ingest/decompose_structured.py`. Proof: `_repos/shared-backend-components/scripts/check_cfpb_lossless_distillation.py`.
...
```bash
PYTHONPATH=. python3 _repos/shared-backend-components/scripts/check_cfpb_lossless_distillation.py --self-test
```
