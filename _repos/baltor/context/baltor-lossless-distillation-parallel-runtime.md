...
> Owner law (2026-06-05). Canonical principle: `_repos/shared-backend-components/docs/codex/lossless-distillation.md`. This workflow
...
1. **Contracts** `_repos/shared-backend-components/schemas/distillation/*.v1` — DistillationRun, DistillationCandidate, DistillationDelta,
...
2. **Lossless store** `_repos/baltor/backend/src/baltor/distillation/{lossless_store,lineage,rehydration,rollback}.py` —
...
19. **Docs** _repos/shared-backend-components/docs/distillation/{overview, lossless-principle, lineage-bundles, rehydration,
