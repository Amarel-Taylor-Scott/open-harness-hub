...
```text
_repos/shared-backend-components/data/baltor-demo-source-catalog.json
```

The builder is:

```bash
python3 _repos/shared-backend-components/scripts/demo_public_source_catalog.py
```
...
graduate into a real context worker once it has tests and receipts.
