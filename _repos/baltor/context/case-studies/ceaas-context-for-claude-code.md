...
acting on "the lift bar is two-axis" can cite `_repos/shared-backend-components/scripts/eval/reason_codes.py` as the single source
...
`_repos/shared-backend-components/scripts/processors/{compression,memory,cache,retrieval}` and `calls: [measurement]` — i.e. it reuses
...
- `processor/structural-compress` — `_repos/shared-backend-components/catalog/processors/compression/structural-compress.yaml`
- `processor/serve-mcp-corpus` — `_repos/shared-backend-components/catalog/processors/deliver/serve-mcp-corpus.yaml`
- `processor/emit-llms-txt` — `_repos/shared-backend-components/catalog/processors/deliver/emit-llms-txt.yaml`
- `processor/package-agent-skill` — `_repos/shared-backend-components/catalog/processors/deliver/package-agent-skill.yaml`
- `processor/emit-claudemd-fragment` — `_repos/shared-backend-components/catalog/processors/deliver/emit-claudemd-fragment.yaml`
- `processor/compression-fidelity-check` — `_repos/shared-backend-components/catalog/processors/verify/compression-fidelity-check.yaml`

(Seeded by `_repos/shared-backend-components/scripts/seed/baltor_components.py`; lifecycle `experimental`.)
