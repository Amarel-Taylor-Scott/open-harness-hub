...
The routine library (`_repos/shared-backend-components/architecture/routine_library.json`) is the canonical inventory of **reusable
...
```bash
python3 _repos/shared-backend-components/scripts/check_routine_library.py --self-test
```
