...
machine-readable in `_repos/shared-backend-components/data/backend-tools.yaml`. Headlines: **Docling→Unstructured** (parse) ·
...
to copy: `_repos/shared-backend-components/scripts/ingest/sanctions_feed_live.py` (live OFAC fetch → verified-context flow).

## Build runbook
Phased, verify-first, context-rot-conscious: [`../../_repos/baltor/context/baltor-context-engine-build.md`](../../_repos/baltor/context/baltor-context-engine-build.md).
