...
Both are already in the catalog (`_repos/shared-backend-components/scripts/seed/context_layer_components.py` = management: memory ·
cache · retrieval · connectors; `_repos/shared-backend-components/scripts/seed/baltor_components.py` = enrichment: tiers · surfaces ·
...
`_repos/shared-backend-components/scripts/seed/baltor_components.py`; lifecycle experimental). Implementation to make Baltor real: the
