...
Implementation: `_repos/shared-backend-components/scripts/pipeline_runtime/cfpb_artifacts.py` and the type
registry `_repos/shared-backend-components/scripts/pipeline_runtime/artifact_types.py`. Held in place by
...
`_repos/shared-backend-components/context/architecture/source-pipeline-artifact-versioning.md`).
...
`_repos/shared-backend-components/scripts/ingest/decompose_structured.py`) and `decompose_cfpb_complaint`, then
