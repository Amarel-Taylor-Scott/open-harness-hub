# AIDONERIGHT-UNIVERSE — how `fundraising` interfaces with the rest of the AI Done Right org
...
## This repo — `fundraising` (`aidoneright-fundraising`)
...
| `fundraising` **← you** | aidoneright-fundraising | business | read | CONTEXT repo — go-to-market + fundraising strategy, investor outreach, round planning, market sizing. The money/market… |
