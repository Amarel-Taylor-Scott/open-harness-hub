...
(function (root) {
  ...
  const ENTITIES = {
    ...
    aidevobserver: {
      ...
      blurb: 'Reviews AI coding sessions to catch reinvention, context waste, duplicate helpers, and cheaper registry-backed paths.',
    ...
    openHubForAI: {
      name: 'OpenHubForAI', wordmark: 'OpenHubForAI', domain: 'OpenHubForAI.io', kind: 'Open registry',
      blurb: 'The open registry of primitives, templates, context, tools, skills, and harnesses that Teleon, Baltor, and AIDevObserver consume. Browse every record.',
