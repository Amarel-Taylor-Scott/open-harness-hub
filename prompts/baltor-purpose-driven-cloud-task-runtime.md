...
- **P1 Contracts** `schemas/purpose_tasks/{PurposeTaskSpec(DONE),PurposeTaskRun,PurposeTaskPath,PurposeTaskScorecard,
...
- **P2 Registry** `architecture/{purpose_task_registry,purpose_task_promotion_policies,
  ...
  · owner · status.
- **P3 Runtime** `src/baltor/purpose_tasks/{registry,planner,runner,backend_selector,evaluator,promotion_gate,
